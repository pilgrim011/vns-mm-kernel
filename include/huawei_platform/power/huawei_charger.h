...
#define NOSTAND_LEVEL_CHARGING_CNT 3
#define USB_LEVEL_CHARGING_CNT 2
...
enum charge_sysfs_type{
    ...
    CHARGE_SYSFS_SUPPORT_LEVEL_CHARGING,
};
...
struct charge_sysfs_data{
    ...
    unsigned int support_level_charging;
};
...
struct charge_core_data{
    ...
    unsigned int ntc_compensation_is;
    unsigned int ntc_compensation_value_1;
    int ntc_compensation_ichg_1;
    unsigned int ntc_compensation_value_2;
    int ntc_compensation_ichg_2;
};
...
struct charge_device_ops{
    ...
    int (*force_ico)(unsigned int *idpm_limit);
};
...
struct charge_device_info{
    ...
    unsigned int pre_start_attemp_level_charging;
    unsigned int start_attemp_level_charging;
    unsigned int support_level_charging;
