...
OAL_STATIC oal_uint32  dmac_config_set_always_tx_1102(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    dmac_config_alrxtx_set_pm(pst_mac_vap, OAL_SWITCH_ON);
...
OAL_STATIC oal_uint32  dmac_config_set_always_rx(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    ...
    /*before set rx flag, disable irq*/
    oal_irq_disable();
...
/*****************************************************************************
 函 数 名  : dmac_config_sync_peer_obss_scan
 功能描述  :
...
*****************************************************************************/
OAL_STATIC oal_uint32  dmac_config_sync_peer_obss_scan(mac_vap_stru *pst_mac_vap, oal_uint8 uc_len, oal_uint8 *puc_param)
{
    oal_uint8 uc_peer_obss_scan;

    if ((OAL_PTR_NULL == pst_mac_vap) || (OAL_PTR_NULL == puc_param))
    {
        OAM_ERROR_LOG0(0, OAM_SF_CFG, "{dmac_config_sync_peer_obss_scan::null param}");
        return OAL_ERR_CODE_PTR_NULL;
    }

    uc_peer_obss_scan = *puc_param;

    OAM_INFO_LOG1(pst_mac_vap->uc_device_id, OAM_SF_CFG, "{dmac_config_sync_peer_obss_scan::uc_peer_obss_scan:%d.}", uc_peer_obss_scan);

    pst_mac_vap->st_cap_flag.bit_peer_obss_scan = uc_peer_obss_scan;
    return OAL_SUCC;
}
...
OAL_STATIC OAL_CONST dmac_config_syn_stru g_ast_dmac_config_syn[] =
{
    ...
    {WLAN_CFGID_SET_PERR_OBSS_SCAN, {0, 0},             dmac_config_sync_peer_obss_scan},
#endif
