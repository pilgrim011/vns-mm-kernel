...
oal_uint32  hmac_ie_proc_obss_scan_ie(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_payload)
{
    ...
    ***************************************************************************/
    ...
    if (0 == us_trigger_scan_interval)
    {
        ...
        hmac_config_sync_peer_obss_scan(pst_mac_vap);
#endif
                               ...
                               oal_uint16      *pus_amsdu_maxsize)
{
    ...
    oal_uint32              ul_change = HMAC_NO_CHANGE;
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
    oal_uint8               uc_obss_scan_ie_found = OAL_FALSE;
#endif
...
/*#ifdef _PRE_WLAN_FEATURE_20_40_80_COEXIST */
        ...
        {
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
            uc_obss_scan_ie_found = OAL_TRUE;
#endif
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
    if(OAL_FALSE == uc_obss_scan_ie_found)
    {
        mac_vap_set_peer_obss_scan(pst_mac_sta, OAL_FALSE);
        hmac_config_sync_peer_obss_scan(pst_mac_sta);
    }
#endif
