...
static void charge_core_tbatt_handler(int temp, struct charge_temp_data temp_data[], struct charge_core_data *data)
{
    ...
    if (1 == data->ntc_compensation_is)
    {
        ichg = -hisi_battery_current();
        if (ichg > data->ntc_compensation_ichg_1){
            if ((temp >= (10 + data->ntc_compensation_value_1))&&(temp < (45 + data->ntc_compensation_value_1))){
                temp = temp - data->ntc_compensation_value_1;
            }
        }else if(ichg > data->ntc_compensation_ichg_2){
            if((temp >= (10 + data->ntc_compensation_value_2))&&(temp < (45 + data->ntc_compensation_value_2))){
                temp = temp - data->ntc_compensation_value_2;
            }
        }else{
            temp = temp;
        }
...
static int charge_core_parse_dts(struct device_node* np, struct charge_core_info *di)
{
    ...
    unsigned int ntc_compensation_value_1 = 0;
    unsigned int ntc_compensation_ichg_1 = 0;
    unsigned int ntc_compensation_value_2 = 0;
    unsigned int ntc_compensation_ichg_2 = 0;
    ...
    if(of_property_read_u32(np, "ntc_compensation_is", &(ntc_compensation_is)))
    {
        ...
        di->data.ntc_compensation_is = ntc_compensation_is;
        hwlog_info("ntc_compensation_is = %d\n",di->data.ntc_compensation_is);
        if(of_property_read_u32(np, "ntc_compensation_value_1", &(ntc_compensation_value_1)))
        {
            hwlog_info("get ntc_compensation_value_1 failed\n");
        }
        di->data.ntc_compensation_value_1 = ntc_compensation_value_1;
        hwlog_info("ntc_compensation_value_1 = %d\n",di->data.ntc_compensation_value_1);
        if(of_property_read_u32(np, "ntc_compensation_ichg_1", &(ntc_compensation_ichg_1)))
        {
            hwlog_info("get ntc_compensation_ichg_1 failed\n");
        }
        di->data.ntc_compensation_ichg_1 = ntc_compensation_ichg_1;
        hwlog_info("ntc_compensation_ichg_1 = %d\n",di->data.ntc_compensation_ichg_1);
        if(of_property_read_u32(np, "ntc_compensation_value_2", &(ntc_compensation_value_2)))
        {
            hwlog_info("get ntc_compensation_value_2 failed\n");
        }
        di->data.ntc_compensation_value_2 = ntc_compensation_value_2;
        hwlog_info("ntc_compensation_value_2 = %d\n",di->data.ntc_compensation_value_2);
        if(of_property_read_u32(np, "ntc_compensation_ichg_2", &(ntc_compensation_ichg_2)))
        {
           hwlog_info("get ntc_compensation_ichg_2 failed\n");
        }
        di->data.ntc_compensation_ichg_2 = ntc_compensation_ichg_2;
        hwlog_info("ntc_compensation_ichg_2 = %d\n",di->data.ntc_compensation_ichg_2);
    }
    //vdpm_para
