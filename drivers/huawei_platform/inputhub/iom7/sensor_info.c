...
static int gsensor_offset[15]; //g-sensor校准参数
...
BH1745_ALS_PARA_TABLE als_para_diff_tp_color_table[] =
{
	...
	{FARADAY,V3,JDI_TPLCD,BLACK,{328, 816, 134, 4004, 4681, 328, 820, 2310, 100, -2305, 7758, -3074, 7675, 1068, 1701, 2879, 2013, 1186, 1212, 500,141, 2908, 6486, 5000, 200  }},
	...
	{FARADAY,V3,JDI_TPLCD,GOLD,{182, 1000, 470,  4204, 3912, 182, 571, 1526, 100, -2251, 5937, -2432, 5392, 924, 1630, 1474, 1970, 994, 1245, 584,129, 3113, 5568, 5000,  200 }},
	...
	{FARADAY,V3,JDI_TPLCD,PINK,{384, 147, 40, 1308, 1386, 384, 1395, 3745, 100, -2626, 12339, -4178 ,13500, 1874, 1872, 8708, 1958, 8474, 4626, 1335, 757, 3647, 5860,5000,200 }},
	...
	{FARADAY,V3,LG_TPLCD,GOLD,{190, 810, 332,  3333, 3385, 190, 680, 1793, 100, -2307, 6971, -2692, 6577, 959, 1634, 1810, 1957, 1392, 1731, 700,176, 3450, 5853, 5000,  200 }},
	...
	{FARADAY,V3,SHARP_TPLCD,GOLD,{190, 810, 332,  3333, 3385, 190, 680, 1793, 100, -2307, 6971, -2692, 6577, 959, 1634, 1810, 1957, 1392, 1731, 700,176, 3450, 5853, 5000,  200 }},
	...
	{FARADAY,V3,DEFAULT_TPLCD,GOLD,{182, 1000, 470,  4204, 3912, 182, 571, 1526, 100, -2251, 5937, -2432, 5392, 924, 1630, 1474, 1970, 994, 1245, 584,129, 3113, 5568, 30000, 0 }},
	...
	{VNS,V4,BOE_TPLCD,GOLD,{198, 551, 442, 2570, 2210, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,BOE_TPLCD,WHITE,{224, 225, 139, 1029, 1049, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,BOE_TPLCD,BLACK,{567, 792, 227, 3205, 2031, 249, 451, 1650, 100, -2512, 7591, -2862, 5730, 1022, 1542, 1866, 1934, 5507, 3392, 4859,613, 1154, 4831, 3200, 300}},
	{VNS,V4,JDI_TPLCD,GOLD,{198, 551, 442, 2570, 2210, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,JDI_TPLCD,WHITE,{224, 225, 139, 1029, 1049, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,JDI_TPLCD,BLACK,{567, 792, 227, 3205, 2031, 249, 451, 1650, 100, -2512, 7591, -2862, 5730, 1022, 1542, 1866, 1934, 5507, 3392, 4859,613, 1154, 4831, 3200, 300}},
	{VNS,V4,LG_TPLCD,GOLD,{198, 551, 442, 2570, 2210, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,LG_TPLCD,WHITE,{224, 225, 139, 1029, 1049, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,LG_TPLCD,BLACK,{567, 792, 227, 3205, 2031, 249, 451, 1650, 100, -2512, 7591, -2862, 5730, 1022, 1542, 1866, 1934, 5507, 3392, 4859,613, 1154, 4831, 3200, 300}},
	{VNS,V4,INX_TPLCD,GOLD,{196, 700, 440, 3342, 3138, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,INX_TPLCD,WHITE,{236, 293, 161, 1401, 1410, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,INX_TPLCD,BLACK,{671, 610, 229, 3121, 1403, 249, 451, 1650, 100, -2512, 7591, -2862, 5730, 1022, 1542, 1866, 1934, 5507, 3392, 4859,613, 1154, 4831, 3200, 300}},
	{VNS,V4,EBBG_TPLCD,GOLD,{196, 700, 440, 3342, 3138, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,EBBG_TPLCD,WHITE,{236, 293, 161, 1401, 1410, 271, 1090, 4239, 100, -2613, 15929, -3946, 13621, 1524, 1749, 6155, 1989, 4990, 4000, 790,512, 2660,6050,5000,200}},
	{VNS,V4,EBBG_TPLCD,BLACK,{671, 610, 229, 3121, 1403, 249, 451, 1650, 100, -2512, 7591, -2862, 5730, 1022, 1542, 1866, 1934, 5507, 3392, 4859,613, 1154, 4831, 3200, 300}},
...
APDS9251_ALS_PARA_TABLE apds_als_para_diff_tp_color_table[] =
{
	...
	{FARADAY,V3,JDI_TPLCD,BLACK,{8996, 1643, 3930, 3543, 2844, 950, 1139, 797, 448, 283, 119, 1024, 1234, 424, 42, 2694, 5371, 5000, 200,0,100}},
	{FARADAY,V3,JDI_TPLCD,WHITE,{6634, 1699, 831, 791, 721, 1010, 1139, 891, 319, 198, 82, 5874, 8059, 3499, 239, 3719, 5654, 5000, 200,0,100}},
	{FARADAY,V3,JDI_TPLCD,GOLD,{6709, 1670,  3991, 3697, 3327, 1017, 1096, 914, 220, 137, 57, 1019, 1375, 545, 38, 3050, 5258, 5000, 200,0,100}},
	...
	{FARADAY,V3,JDI_TPLCD,PINK,{19889, 1389, 976, 910, 718, 845, 1037, 693, 302, 190, 80, 7536, 5924, 1385, 232, 3312, 5050,5000,200,0,100}},
	...
	{FARADAY,V3,LG_TPLCD,GOLD,{7429, 1713,  3471, 3397, 3164, 992, 1106, 880, 225, 142, 59, 1270, 1733, 601, 44, 3343, 5231, 5000, 200,0,100}},
	...
	{FARADAY,V3,SHARP_TPLCD,GOLD,{7429, 1713,  3471, 3397, 3164, 992, 1106, 880, 225, 142, 59, 1270, 1733, 601, 44, 3343, 5231, 5000, 200,0,100}},
	...
	{FARADAY,V3,DEFAULT_TPLCD,GOLD,{6709, 1670,  3991, 3697, 3327, 1017, 1096, 914, 220, 137, 57, 1019, 1375, 545, 38, 3050, 5258, 20000, 0,0,100}},
	{FARADAY,V3,DEFAULT_TPLCD,BLUE,{1024, 1693, 4071, 2242, 2242, 1263, 1460, 1096, 1718, 1250, 572, 788, 1495, 3312, 165, 3381, 5996, 20000, 0,0,100}},
	...
	{VNS,V4,BOE_TPLCD,GOLD,{8471, 2307, 3315, 3100, 2760, 1006, 715, 800, 221, 147, 66, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,BOE_TPLCD,WHITE,{16434, 1333, 1441, 1437, 1239, 1036, 751, 866, 309, 200, 93, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,BOE_TPLCD,BLACK,{3922, 1925, 5985, 2080, 1749, 965, 1301, 853, 1051, 590, 400, 886, 1124, 287, 34, 3102, 4587,3200,300,1,430}},
	{VNS,V4,JDI_TPLCD,GOLD,{8471, 2307, 3315, 3100, 2760, 1006, 715, 800, 221, 147, 66, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,JDI_TPLCD,WHITE,{16434, 1333, 1441, 1437, 1239, 1036, 751, 866, 309, 200, 93, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,JDI_TPLCD,BLACK,{3922, 1925, 5985, 2080, 1749, 965, 1301, 853, 1051, 590, 400, 886, 1124, 287, 34, 3102, 4587,3200,300,1,430}},
	{VNS,V4,LG_TPLCD,GOLD,{8471, 2307, 3315, 3100, 2760, 1006, 715, 800, 221, 147, 66, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,LG_TPLCD,WHITE,{16434, 1333, 1441, 1437, 1239, 1036, 751, 866, 309, 200, 93, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,LG_TPLCD,BLACK,{3922, 1925, 5985, 2080, 1749, 965, 1301, 853, 1051, 590, 400, 886, 1124, 287, 34, 3102, 4587,3200,300,1,430}},

	{VNS,V4,INX_TPLCD,GOLD,{10079, 1804, 3986, 3917, 3431, 930, 1160, 806, 182, 149, 66, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,INX_TPLCD,WHITE,{6240, 1954, 1950, 1803, 1532, 940, 1218, 844, 294, 217, 92, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,INX_TPLCD,BLACK,{3711, 798, 4004, 1293, 975, 1639, 1778, 1392, 1013, 810, 560, 886, 1124, 287, 34, 3102, 4587,3200,300,1,38}},
	{VNS,V4,EBBG_TPLCD,GOLD,{10079, 1804, 3986, 3917, 3431, 930, 1160, 806, 182, 149, 66, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,EBBG_TPLCD,WHITE,{6240, 1954, 1950, 1803, 1532, 940, 1218, 844, 294, 217, 92, 886, 1124, 287, 34, 3102, 4587,3200,300,0,100}},
	{VNS,V4,EBBG_TPLCD,BLACK,{3711, 798, 4004, 1293, 975, 1639, 1778, 1392, 1013, 810, 560, 886, 1124, 287, 34, 3102, 4587,3200,300,1,38}},
...
int write_gsensor_offset_to_nv(char* temp)
{
	...
	hwlog_info( "nve_direct_access write temp (%d %d %d  %d %d %d %d %d %d  %d %d %d %d %d %d )\n", *poffset_data, *(poffset_data + 1), *(poffset_data + 2),*(poffset_data + 3),
        *(poffset_data + 4),*(poffset_data + 5),*(poffset_data + 6), *(poffset_data + 7),*(poffset_data + 8),*(poffset_data + 9),*(poffset_data + 10),*(poffset_data + 11),*(poffset_data + 12), 
...
{
	write_customize_cmd_noresp(TAG_ACCEL, CMD_ACCEL_OFFSET_REQ, &gsensor_calibrate_data, sizeof(int) * 15);
	if(1==akm_cal_algo)
	{
	...
	write_customize_cmd_noresp(TAG_GYRO, CMD_GYRO_OFFSET_REQ, &gyro_sensor_calibrate_data, sizeof(int) * 15);
...
static int acc_calibrate_save(const void *buf, int length)
{
	...
	hwlog_info( "%s:gsensor calibrate ok, %d  %d  %d %d  %d  %d %d  %d  %d %d  %d  %d %d  %d  %d\n", __func__, *poffset_data, *(poffset_data + 1), *(poffset_data + 2),*(poffset_data + 3), 
        *(poffset_data + 4),*(poffset_data + 5), *(poffset_data + 6), *(poffset_data + 7),*(poffset_data + 8), *(poffset_data + 9),*(poffset_data + 10),*(poffset_data + 11), 
				...
				struct device_attribute *attr, const char *buf, size_t count)
{
	...
	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_00, *(acc_cali_data+6), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_01, *(acc_cali_data+7), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_02, *(acc_cali_data+8), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_10, *(acc_cali_data+9), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_11, *(acc_cali_data+10), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_12, *(acc_cali_data+11), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_20, *(acc_cali_data+12), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_21, *(acc_cali_data+13), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);

	memset(&content, 0, sizeof(content));
	snprintf(content, CLI_CONTENT_LEN_MAX, ACC_CALI_XIS_22, *(acc_cali_data+14), ((return_calibration == SUC)?"pass":"fail"), (int)val,
		get_cali_error_code(return_calibration), date_str);
	save_to_file(DATA_CLLCT, content);
				...
				struct device_attribute *attr, const char *buf, size_t count)
{
	...
	else
	{
		if(val == 1){
		    ...
		    gyro_calibrate_save(gyro_calib_data, pkg_mcu.data_length);
		}
		else if(val == 7){
		...
		hwlog_info("gyro calibrate success, val=%d data=%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d, len=%d\n", val,gyro_calib_data[0],gyro_calib_data[1],gyro_calib_data[2],
	...
	if(val == 1 || val == 7){
	    ...
	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_00, gyro_calib_data[6], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_01, gyro_calib_data[7], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_02, gyro_calib_data[8], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_10, gyro_calib_data[9], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_11, gyro_calib_data[10], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_12, gyro_calib_data[11], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_20, gyro_calib_data[12], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_21, gyro_calib_data[13], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);

	    memset(&content, 0, sizeof(content));
	    snprintf(content, CLI_CONTENT_LEN_MAX, GYRO_CALI_XIS_22, gyro_calib_data[14], ((gyro_calibration_res == SUC)?"pass":"fail"),(int)val,
	    get_cali_error_code(gyro_calibration_res), date_str);
	    save_to_file(DATA_CLLCT, content);
	}
