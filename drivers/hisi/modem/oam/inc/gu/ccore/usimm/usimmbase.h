...
#define EF_CUIM_RUIMID                          (0x6F31)   /*T*/
...
enum USIMM_MNTN_STATE_ERROR_ENUM
{
    ...
    USIMM_MNTN_GUTL_AUTH_FAIL,
    USIMM_MNTN_CDMA_AUTH_FAIL,
    USIMM_MNTN_IMS_AUTH_FAIL,
...
/*****************************************************************************
 ...
 结构说明  : USIMM ERROR LOG 事件枚举
*****************************************************************************/
enum USIMM_MNTN_INIT_ERROR_REASON_ENUM
{
...
{
    VOS_UINT32                              ulIndex;
    USIMM_MNTN_SINGLEINFO_STRU              astModuleInfo[USIMM_MNTN_INFODATA_MAX];
...
typedef struct
{
    ...
    USIMM_MNTN_APPINFO_STRU                         stMNTNBaseAppInfo;
    USIMM_MNTN_APPINFO_STRU                         stMNTNLogi1AppInfo;
...
#define USIMM_NORMAL_LOG(string)    (VOS_VOID)DIAG_LogReport(USIMM_GEN_LOG_MODULE(PS_LOG_LEVEL_NORMAL),WUEPS_PID_USIM, __FILE__, __LINE__, "Normal:%s", string)
#define USIMM_INFO_LOG(string)      (VOS_VOID)DIAG_LogReport(USIMM_GEN_LOG_MODULE(PS_LOG_LEVEL_NORMAL),WUEPS_PID_USIM, __FILE__, __LINE__, "Info:%s", string)
#define USIMM_WARNING_LOG(string)   (VOS_VOID)DIAG_LogReport(USIMM_GEN_LOG_MODULE(PS_LOG_LEVEL_WARNING),WUEPS_PID_USIM, __FILE__, __LINE__, "Warning:%s", string)
#define USIMM_ERROR_LOG(string)     (VOS_VOID)DIAG_LogReport(USIMM_GEN_LOG_MODULE(PS_LOG_LEVEL_ERROR),WUEPS_PID_USIM, __FILE__, __LINE__, "Error:%s", string)
#endif
...
{
    USIMM_MNTN_MODULE_DL            = 0,
    USIMM_MNTN_MODULE_INIT          = 1,
    USIMM_MNTN_MODULE_STATE         = 2,
    USIMM_MNTN_MODULE_BUTT
};
typedef  VOS_UINT32  USIMM_MNTN_MODULE_ENUM_UINT32;
