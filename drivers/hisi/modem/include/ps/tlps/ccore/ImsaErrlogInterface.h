...
#define IMSA_ERR_MAX_APN_LEN                             (99)
...
enum IMSA_OM_ERR_LOG_MSG_TYPE_ENUM
{
    ...
    ID_IMSA_OM_IMS_REG_FAIL_EVENT_REPORT            = 0x0a, /* _H2ASN_MsgChoice IMSA_OM_IMS_REG_FAIL_EVENT_REPORT_STRU*/
    ID_IMSA_OM_IMS_INIT_DEREG_EVENT_REPORT          = 0x0b, /* _H2ASN_MsgChoice IMSA_OM_IMS_INIT_DEREG_EVENT_REPORT_STRU*/
    ID_IMSA_OM_IMS_REG_TIMER_EXPIRE_EVENT_REPORT    = 0x0c, /* _H2ASN_MsgChoice IMSA_OM_IMS_REG_TIMER_EXPIRE_EVENT_REPORT_STRU*/
    ID_IMSA_OM_IMS_REG_SUCC_EVENT_REPORT            = 0x0d, /* _H2ASN_MsgChoice IMSA_OM_IMS_REG_SUCC_EVENT_REPORT_STRU*/
...
enum IMSA_ERR_LOG_ALM_ID_ENUM
{
    ...
    /* CHR主动上报的ALAM ID*/
    IMSA_ERR_LOG_ALM_IMS_REG_FAIL_EVENT_REPORT          = 0x0b,
    IMSA_ERR_LOG_ALM_IMS_INIT_DEREG_EVENT_REPORT        = 0x0c,
    IMSA_ERR_LOG_ALM_IMS_REG_TIMER_EXPIRE_EVENT_REPORT  = 0x0d,
    IMSA_ERR_LOG_ALM_IMS_REG_SUCC_EVENT_REPORT          = 0x0e,
...
enum IMSA_ERR_LOG_REG_FAIL_REASON_ENUM
{
    ...
    IMSA_ERR_LOG_REG_FAIL_REASON_ROAMING_NOT_SUPPORT_REG= 0x06,     /**< 注册过程中移动到漫游网络，导致注册失败 */
    IMSA_ERR_LOG_REG_FAIL_REASON_SIP_PDP_RELEASE        = 0x07,     /**< 信令承载被释放，导致注册失败 */
...
enum IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_ENUM
{
    ...
    IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_NO_PCSCF,
    IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_PERM_FORBIDDEN,                      /**< 承载被拒原因值永久被拒 */
...
/*****************************************************************************
 ...
 枚举说明  :  紧急呼叫失败的原因值
*****************************************************************************/
enum IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_ENUM
{
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_NW_NOT_SUPPORT_VOPS,       /* 网侧不支持VOPS */
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_VOICE_DAOMAIN_CS_ONLY,     /* VOICE DOMAIN配置为CS ONLY*/
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_UE_NOT_SUPPORT_IMS_VOICE,  /* UE不支持IMS VOICE */
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_IMPU_INVALIED,             /* IMPU无效 */
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_IMPI_INVALIED,             /* IMPI无效 */
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_DOMAIN_INVALIED,           /* DOMAIN无效 */
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_NOT_SUPPORT_ROAMING_REG,   /* 漫游网络下不允许注册*/
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_REG_FORBIDEN,              /* UE被禁*/
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_TEMP_FORBIDEN_TIMER_RUNNING, /* 临时被禁定时器在运行 */
    IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_USIM_LOCK,                 /* 被锁卡 */
};
typedef VOS_UINT16  IMSA_ERR_LOG_NOT_INIT_IMS_REG_REASON_ENUM_UINT16;

/*****************************************************************************
 枚举名    :  IMSA_OM_IMS_REG_FAIL_REASON_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  :  IMS注册失败的原因值
*****************************************************************************/
enum IMSA_OM_IMS_REG_FAIL_REASON_ENUM
{
    IMSA_OM_IMS_REG_FAIL_REASON_NOT_INIT_IMS_REG,
    IMSA_OM_IMS_REG_FAIL_REASON_PDN_CONN_FAIL,
    IMSA_OM_IMS_REG_FAIL_REASON_IMS_REG_FAIL,
};
typedef VOS_UINT16  IMSA_OM_IMS_REG_FAIL_REASON_ENUM_UINT16;
...
/*****************************************************************************
 ...
 枚举说明  :  IMS注册失败的原因值
*****************************************************************************/
enum IMSA_OM_IMS_TIMER_EXPIRE_REASON_ENUM
{
    IMSA_OM_IMS_TIMER_EXPIRE_REASON_PDN_CONN,
    IMSA_OM_IMS_TIMER_EXPIRE_REASON_REG,
    IMSA_OM_IMS_TIMER_EXPIRE_REASON_BUTT,
};
typedef VOS_UINT32  IMSA_OM_IMS_TIMER_EXPIRE_REASON_ENUM_UINT32;


/*****************************************************************************
 枚举名    : IMSA_ERR_LOG_UNSOLI_REPORT_TYPE_ENUM_UINT16
 枚举说明  : err log主动上报类型
 1.日    期   : 2016年03月29日
   作    者   : wangchen 00209181
   修改内容   : 新建
*****************************************************************************/
enum IMSA_ERR_LOG_UNSOLI_REPORT_TYPE_ENUM
{
    IMSA_ERR_LOG_FAULT_REPORT                                = 0x01,             /* 故障上报 */
    IMSA_ERR_LOG_ALARM_REPORT                                = 0x02,             /* 告警上报 */

    IMSA_ERR_LOG_REPORT_TYPE_BUTT
};
typedef VOS_UINT16  IMSA_ERR_LOG_UNSOLI_REPORT_TYPE_ENUM_UINT16;
...
{
    OM_ERR_LOG_HEADER_STRU                              stHeader;           /*消息头*/
    VOS_UINT32                                          ulPdnConnTimerLen;
    VOS_UINT32                                          ulImsRegTimerLen;
}IMSA_ERR_LOG_IMS_REG_TIMER_EXPIRE_EVENT;
...
/*****************************************************************************
 结构名称: IMSA_ERR_LOG_APN_STRU
 结构说明: PDP上下文中APN信息
*****************************************************************************/
typedef struct
{
    VOS_UINT8                           ucLength;
    VOS_UINT8                           aucValue[IMSA_ERR_MAX_APN_LEN];

} IMSA_ERR_LOG_APN_STRU;

/*****************************************************************************
 结构名称   :IMSA_ERR_LOG_NOT_INIT_IMS_REG_STRU
 协议表格   :
 ASN.1 描述 :
 结构说明   : 不发起IMS注册的原因值
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT8                                           aucRsv[2];
} IMSA_ERR_LOG_NOT_INIT_IMS_REG_STRU;
...
typedef struct
{
    IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_ENUM_UINT32      enPdnConnRejCause;  /* IMS PDN连接被拒原因值 */
    IMSA_ERR_LOG_PDN_CONN_NW_REJ_CAUSE_ENUM_UINT16  enNwRejCause;       /* PDN被网侧拒绝的原因值，只有在enPdnConnRejCause为CN REJ时有效 */
    VOS_UINT8                                       ucPermForbFlag;     /* IMS注册被拒后，是否是永久被拒原因值 */
    VOS_UINT8                                       ucTermForbFlag;     /* IMS注册被拒后，是否是临时被拒原因值 */
    IMSA_ERR_LOG_APN_STRU                           stImsaApn;
}IMSA_ERR_LOG_PDN_CONN_FAIL_REASON_STRU;
...
typedef struct
{
    ...
    VOS_UINT8                                       ucPermForbFlag;     /* IMS注册被拒后，是否是永久被拒原因值 */
    VOS_UINT8                                       ucTermForbFlag;     /* IMS注册被拒后，是否是临时被拒原因值 */
}IMSA_ERR_LOG_IMS_REG_FAIL_REASON_STRU;

/*****************************************************************************
 结构名称   : IMSA_OM_IMS_REG_FAIL_EVENT_REPORT_STRU
 协议表格   :
 ASN.1 描述 :
 结构说明   : IMS注册失败事件上报结构体
*****************************************************************************/
...
{
    OM_ERR_LOG_HEADER_STRU                  stHeader;           /*消息头*/
    IMSA_OM_IMS_REG_FAIL_REASON_ENUM_UINT16 enImsRegFailReason; /* 注册失败的原因 */
    VOS_UINT8                               aucRsv[2];

    IMSA_ERR_LOG_NOT_INIT_IMS_REG_STRU      stNotInitRegReason;
    IMSA_ERR_LOG_PDN_CONN_FAIL_REASON_STRU  stPdnConnFailReason;
    IMSA_ERR_LOG_IMS_REG_FAIL_REASON_STRU   stImsRegFailReason;
}IMSA_ERR_LOG_ALM_IMS_REG_FAIL_EVENT_REPORT_STRU;

/*****************************************************************************
 结构名称   : IMSA_OM_IMS_INIT_DEREG_EVENT_REPORT_STRU
 协议表格   :
 ASN.1 描述 :
 结构说明   : IMS发起去注册事件上报结构体
*****************************************************************************/
typedef struct
{
    OM_ERR_LOG_HEADER_STRU                      stHeader;           /*消息头*/
    IMSA_ERR_LOG_INIT_DEREG_REASON_ENUM_UINT32  enInitDeregCause;   /*  */
}IMSA_ERR_LOG_ALM_IMS_INIT_DEREG_EVENT_REPORT_STRU;


/*****************************************************************************
 结构名称   : IMSA_OM_IMS_REG_TIMER_EXPIRE_EVENT_REPORT_STRU
 协议表格   :
 ASN.1 描述 :
 结构说明   : IMS发起去注册事件上报结构体
*****************************************************************************/
...
{
    OM_ERR_LOG_HEADER_STRU                      stHeader;           /*消息头*/
    IMSA_OM_IMS_TIMER_EXPIRE_REASON_ENUM_UINT32 enTimeExpireReason;
    VOS_UINT32                                  ulPdnConnTimerLen;
    VOS_UINT32                                  ulImsRegTimerLen;
}IMSA_ERR_LOG_ALM_IMS_REG_TIMER_EXPIRE_EVENT_REPORT_STRU;
...
typedef struct
{
    ...
    VOS_UINT32                              ulPdnConnTimerLen;
    VOS_UINT32                              ulImsRegTimerLen;
}IMSA_ERR_LOG_ALM_IMS_REG_SUCC_EVENT_REPORT_STRU;

/*******************************************************************************
 结构名    : IMSA_ERR_LOG_ALM_REPORT_TYPE_STRU
...
typedef struct
{
    ...
    IMSA_ERR_LOG_UNSOLI_REPORT_TYPE_ENUM_UINT16     enReportType;       /* 上报log等级 */
}IMSA_ERR_LOG_ALM_REPORT_TYPE_STRU;
