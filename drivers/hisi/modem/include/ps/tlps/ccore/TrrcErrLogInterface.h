...
enum TRRC_ERRORLOG_ALARM_ID_ENUM
{
    ...
    TRRC_ERRORLOG_ALARM_ID_PRACH_CCODE_INFO,              /*双码道信息的情况*/
...
enum TRRC_APP_ERROR_CODE_ENUM
{
    ...
    TRRC_APP_RRC_CONNSETUP_RSVD_MSG_MAX           = 98, /*TRRC在组装完RRC CONN SETUP COMPLETE后进入CNF态,此时收到多条
                                                          UM_DATA_IND致使缓存达到最大值走CONN TO IDLE流程*/
    TRRC_APP_PRACH_CODE_INFO_ERR                  = 100, /*双码道信息的错误码*/
...
/*****************************************************************************
 结构名    : TRRC_CHR_PRACH_CCODE_INFO_STRU
 结构说明  : TDS双码道信息
*****************************************************************************/
typedef struct
{
    VOS_UINT32                                 ulTimeStamp;     /* 记录时间戳 */
    VOS_UINT32                                 ulMcc;           /* MCC,3 bytes      */
    VOS_UINT32                                 ulMnc;           /* MNC,2 or 3 bytes */
    VOS_UINT16                                 usFrequency;     /* 小区中心频点 单位:100Khz */
    VOS_UINT16                                 usCellId;        /* 小区ID信息 */
    VOS_UINT32                                 ulCellIdentity;  /* 物理小区ID */
    VOS_UINT32                                 ulCcodeInfo;     /* 双码道配置信息 sf4:4 sf8:8 sf16:16*/
    VOS_UINT16                                 usLac;           /* lac */
    VOS_UINT8                                  ucRac;           /* Rac */
...
/*****************************************************************************
 结构名    : TRRC_APP_PRACH_CCODE_CHR_INFO_STRU
 结构说明  : 双码道上报结构
*****************************************************************************/
typedef struct
{
    ...
    TRRC_APP_ERROR_CODE_ENUM_UINT8             enErrorCode;             /* 错误码*/
    VOS_UINT8                                  aucResv[3];              /* 保留位 */
    TRRC_CHR_PRACH_CCODE_INFO_STRU             stTrrcPrachCcodeInfo;    /*双码道信息*/
