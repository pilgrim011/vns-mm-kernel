...
enum    IMSA_INTRA_MSG_ID_ENUM
{
    ...
    ID_IMSA_SMS_RESULT_ACTION_IND       = 0x212,                /* _H2ASN_MsgChoice IMSA_SMS_RESULT_ACTION_IND_STRU*/
...
/*****************************************************************************
 结构名    : IMSA_SMS_RESULT_ACTION_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : IMSA_SMS_RESULT_ACTION_IND_STRU消息结构定义
*****************************************************************************/
/**
 * \brief 短信失败且需要主控模块进行其它操作时，通过此结构传递需要进行的操作
 */
typedef struct
{
    VOS_MSG_HEADER
    ...
    IMSA_RESULT_ACTION_ENUM_UINT32          enResultAction;     /**< 短信失败后请求主控模块执行的操作 */
    // TODO: other param
} IMSA_SMS_RESULT_ACTION_IND_STRU;
...
extern VOS_UINT32 IMSA_CONN_HasEmcActiveVoicePdp
(
    VOS_VOID
);
/*****************************************************************************
