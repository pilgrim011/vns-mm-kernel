...
)
{
    ...
    /*如果当前service change ind消息中带的标志当前注册成功类型有效的标志位为true,
     根据当前注册类型进行处理*/
    if(VOS_TRUE == pstServiceChangeInd->bitRegSuccProcTypeValid)
    {
        /*这里的处理策略是:如果是L的注册类型为假的TAU或为无效值,直接丢弃,不再触发IMS注册*/
...
/*****************************************************************************
 ...
 Description     : 根据两个32K时间戳计算差值，返回单位精度为毫秒
 Input           :
 Output          : None
 Return          :
...
/*****************************************************************************
 函 数 名  : IMSA_NotInitRegEventReport
 功能描述  : 记录IMSA不发起注册的原因值,主动上报
...
/*****************************************************************************
 函 数 名  : IMSA_PdnConnTimerExpireEventReport
 功能描述  : IMS承载建立时间超时事件上报
 输入参数  : enRegFailReason  注册失败原因值
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
...
/*****************************************************************************
 函 数 名  : IMSA_RegTimerExpireEventReport
 功能描述  : IMS注册时间超时事件上报
 输入参数  :
 输出参数  : 无
 返 回 值  : VOS_VOID
...
/*****************************************************************************
 函 数 名  : IMSA_SRV_RegSuccEventReport
 功能描述  : IMS注册成功事件上报
 输入参数  :
 输出参数  : 无
 返 回 值  : VOS_VOID
...
/*****************************************************************************
 函 数 名  : IMSA_SRV_InitDeregEventReport
 功能描述  : UE主动触发的去激活事件上报
 输入参数  :
 输出参数  : 无
 返 回 值  : VOS_VOID
...
/*****************************************************************************
 ...
 Description    : IMSA内部消息ID_IMSA_SMS_RESULT_ACTION_IND处理函数
 Input          : pstCallRsltActionIndMsg--------------消息指针
 Output         : VOS_VOID
 Return Value   : VOS_VOID
