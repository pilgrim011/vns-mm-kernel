...
)
{
    ...
    #if (FEATURE_ON == FEATURE_PTM)
    /* 增加承载建立失败的CHR上报 */
    IMSA_CONN_PdnConnFailEventReport(IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_NW_REJ,
                                    (IMSA_ERR_LOG_PDN_CONN_NW_REJ_CAUSE_ENUM_UINT16)IMSA_PDN_CnRejCauseProc(pstPdpActivateRej->enCause));
    #endif
...
)
{
    ...
    if (TAF_PS_CAUSE_PDP_ACTIVATE_LIMIT == pstCallOrigCnf->enCause)
    {
        ...
        /* 增加承载建立失败的CHR上报 */
        IMSA_CONN_PdnConnFailEventReport(IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_PDP_ACTIVATE_LIMIT,IMSA_ERR_LOG_PDN_CONN_NW_REJ_CAUSE_BUTT);
    ...
    else if (TAF_PS_CAUSE_OPERATION_CONFLICT == pstCallOrigCnf->enCause)
    {
        ...
        /* 增加承载建立失败的CHR上报 */
        IMSA_CONN_PdnConnFailEventReport(IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_SAME_APN_OPERATING,IMSA_ERR_LOG_PDN_CONN_NW_REJ_CAUSE_BUTT);
        #endif
    }
    else
    {
        ...
        /* 增加承载建立失败的CHR上报 */
        IMSA_CONN_PdnConnFailEventReport(IMSA_ERR_LOG_NORM_PDNREJ_CAUSE_IMSA_PARA_ERR,IMSA_ERR_LOG_PDN_CONN_NW_REJ_CAUSE_BUTT);
        #endif
    }
