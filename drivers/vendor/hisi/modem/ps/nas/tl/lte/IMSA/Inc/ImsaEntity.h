...
typedef struct
{
    ...
    VOS_UINT8                           ucNonSrvccRatChgFlag;
    VOS_UINT8                           ucMediaLostRelCallFlag;
    VOS_UINT8                           aucRsv[1];
    VOS_UINT32                          ulDialogId;    /* Indicates the dialog id */
...
typedef struct
{
    ...
    IMSA_TIMER_STRU                     stNormMediaLostRelCallTimer;    /* 媒体承载被释放后，主动挂断电话的定时器 */
    IMSA_TIMER_STRU                     stEmcMediaLostRelCallTimer;     /* 媒体承载被释放后，主动挂断电话的定时器 */
...
typedef struct
{
    ...
    VOS_UINT8                           ucNonSrvccNotRelCallFlag;       /**< 非SRVCC得异系统变化导致的挂断电话*/
    VOS_UINT8                           ucMediaLostNotRelCallFlag;     /**< 媒体承载释放后挂断电话的NV，VOS_TRUE:挂断 */
...
typedef struct
{
    ...
    /* 承载建立时间 */
    LPS_32K_TIMESTAMP                   stStartConnTStamp;      /**< 发起建链的起始时间 */
    LPS_32K_TIMESTAMP                   stStopConnTStamp;       /**< 建链成功的最终时间 */

    /* 注册的起始时间 */
    LPS_32K_TIMESTAMP                   stStartRegTStamp;       /**< 发起注册的起始时间 */
    LPS_32K_TIMESTAMP                   stStopRegTStamp;        /**< 注册成功的最终时间 */
...
#define IMSA_SetRegSuccProcType(enRegSuccProcType)            (pgstImsaEntity->stImsaControlManager.enRegSuccProcType = (enRegSuccProcType))
#define IMSA_GetRegSuccProcType()                             (pgstImsaEntity->stImsaControlManager.enRegSuccProcType)
...
#define IMSA_GetErrlogStartConnTimerAddr()      (&(pgstImsaEntity->stImsaErrorlogManager.stStartConnTStamp))
#define IMSA_GetErrlogStopConnTimerAddr()       (&(pgstImsaEntity->stImsaErrorlogManager.stStopConnTStamp))

#define IMSA_GetErrlogStartRegTimerAddr()       (&(pgstImsaEntity->stImsaErrorlogManager.stStartRegTStamp))
#define IMSA_GetErrlogStopRegTimerAddr()        (&(pgstImsaEntity->stImsaErrorlogManager.stStopRegTStamp))
