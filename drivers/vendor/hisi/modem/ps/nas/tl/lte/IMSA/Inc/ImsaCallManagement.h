...
#define IMSA_CALL_TIMER_LEN_BEAR_LOST_REL_CALL    (2*1000)
#else
...
extern VOS_VOID IMSA_CallProcTimeoutNormMediaLost(const VOS_VOID *pTimerMsg);
extern VOS_VOID IMSA_CallProcTimeoutEmcMediaLost(const VOS_VOID *pTimerMsg);
extern VOS_VOID IMSA_CallProcSrvccFail(VOS_VOID);
extern VOS_UINT32 IMSA_IsExistEmcCall(VOS_VOID);
extern VOS_UINT32 IMSA_IsExistNormCall(VOS_VOID);
