...
#define IMSA_CONN_TIMER_THRESHOLD       (200)   /* 单位ms */
#define IMSA_REG_TIMER_THRESHOLD        (1500)  /* 单位ms */
...
enum IMSA_TIMER_ID_ENUM
{
    ...
    TI_IMSA_CALL_NORM_MEDIA_LOST_REL_CALL   = 0x0308,           /* 媒体承载释放后主动挂断电话的定时器 */
    TI_IMSA_CALL_EMC_MEDIA_LOST_REL_CALL    = 0x0309,           /* 媒体承载释放后主动挂断电话的定时器 */
