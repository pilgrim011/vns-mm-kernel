...
#define NAS_MML_SIM_MAX_LAI_LEN                           (6)                       /* 最大的LAI的长度 */
#define NAS_MML_SIM_MAX_RAI_LEN                           (6)                       /* 最大的RAI的长度 */
...
typedef struct
{
    ...
    VOS_UINT8                           aucLai[NAS_MML_SIM_MAX_LAI_LEN];        /* 记录上次的LAI */
    VOS_UINT8                           aucRai[NAS_MML_SIM_MAX_RAI_LEN];        /* 记录上次的RAI */
...
/*****************************************************************************
 结构名    : NAS_MML_PLMN_WITH_CNT_AND_RAT_STRU
 结构说明  : NAS MML PLMN和搜网次数
 1.日    期   : 2016年03月16日
   作    者   : j00174725
   修改内容   : 新增
*****************************************************************************/
...
{
    NAS_MML_PLMN_ID_STRU                stPlmnId;
    VOS_UINT8                           ucSearchCnt;                            /* 当前PLMN搜网次数 */
