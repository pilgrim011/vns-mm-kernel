...
/*****************************************************************************
 函 数 名  : NAS_GMM_IsPowerOffTriggeredDetach
 功能描述  : 判断是否是POWER OFF触发的DETACH流程
 输入参数  : 无
 输出参数  : 无
 返 回 值  : VOS_TRUE  - 是
             VOS_FALSE - 不是
...
/*****************************************************************************
 函 数 名  : NAS_GMM_IsNeedIgnoreAuthenAndCipherReq
 功能描述  : 判断是否需要忽略GMM_MSG_AUTHENTICATION_AND_CIPHERING_REQUEST
 输入参数  : 无
 输出参数  : 无
 返 回 值  : VOS_TRUE  - 需要
             VOS_FALSE - 不需要
 ...
 *****************************************************************************/
 ...
 修改历史      :
  ...
  2.日    期   : 2015年3月2日
    作    者   : z00359541
    修改内容   : DTS2016022908722: T3302在运行时，使用AttemptUpdateRai与当前RAI进行判断是否RAI改变
*****************************************************************************/
