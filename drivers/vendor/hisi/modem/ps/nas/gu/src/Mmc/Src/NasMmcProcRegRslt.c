...
)
{
    ...
    /* Added by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-11, begin */
    /* 保存真流程的注册结果上下文时，清除假流程标志 */
    ...
    /* Added by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-11, end */
...
/* Added by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-11, begin */
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLteUnrealRegProcFlg
 功能描述  : 获取当前是否是LTE下未跟网测交互的注册流程标志
 输入参数  : 无
 输出参数  : 无
...
/*****************************************************************************
 函 数 名  : NAS_MMC_SetLteUnrealRegProcFlg
 功能描述  : 设置当前是否是LTE下未跟网测交互的注册流程标志
 输入参数  : ucLteUnrealRegProcFlg
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
 被调函数  :
...
NAS_MMC_ADDITIONAL_ACTION_ENUM_UINT8 NAS_MMC_ProcCsRegFailCause257AccessBarrd(VOS_VOID)
{
    ...
    {
        /* Modified by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-5, begin */
        ...
        /* Modified by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-5, end */
    }
    else
    {
...
)
{
    ...
    else
    {
        ...
        *penCsAddition = NAS_MMC_ADDITIONAL_ACTION_NORMAL_CAMP_ON;
        ...
        /* Added by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-7, begin */
        /* LTE TAU假流程，置标志位 */
        NAS_MMC_SetLteUnrealRegProcFlg(VOS_TRUE);
        NAS_NORMAL_LOG(WUEPS_PID_MMC,"NAS_MMC_ProcLmmCombinedTauResultInd_TauRsltSucc: Update Reg state and Service state");
        NAS_MMC_UpdateServiceState_RegSucc(NAS_MSCC_PIF_SRVDOMAIN_CS_PS, NAS_MMC_NORMAL_SERVICE);
        /* Added by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-7, end */
