...
/*****************************************************************************
 函 数 名  : NAS_MM_RelAllExistSsConn
 功能描述  : 释放所有存在的ss业务对应的MM连接
 输入参数  : NAS_MMCM_REL_CAUSE_ENUM_UINT32      enMmCcRelCause
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MM_GetMmCmRelCause
 功能描述  : 根据MM当前状态获取MMCM REL原因值
 输入参数  :
 输出参数  :
 返 回 值  : 给CM发REL IND消息需要携带的原因值
 调用函数  :
 被调函数  :
