...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLRegSuccRsltType
 功能描述  : 判断当前L注册成功结果的类型
 输入参数  : 无
 输出参数  : 无
 返 回 值  : NAS_MSCC_PIF_PS_REG_PROC_ENUM_UINT32:当前L注册成功结果的类型
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MMC_IsDomainValidForPsRegCnRsltInd
 功能描述  : 当前域上是否可以给MSCC发送PS REG RSLT IND消息
 输入参数  : ulCnDomainId:域ID
 输出参数  : 无
 返 回 值  : VOS_TRUE: 可以 VOS_FALSE: 不可以
 调用函数  :
 被调函数  :
 修改历史      :
  1.日    期   : 2016年4月5日
...
/*****************************************************************************
 ...
 修改历史      :
  ...
  2.日    期   : 2016年4月5日
    作    者   : z00359541
    修改内容   : MSCC_IMSA_SERVICE_CHANGE_IND 接口调整:  增加真假流程的判断，以便
                 MSCC在通知IMSA SERVICE CHANGE时，IMSA能知道此次是真流程还是假流程
                 触发的
*****************************************************************************/
