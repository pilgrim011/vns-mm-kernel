...
typedef struct
{
    ...
    /* Modified by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-11, begin */
    VOS_UINT8                           ucLteUnrealRegProcFlg;                  /* 记录当前是否是LTE下的没有和网测交互的注册流程 */
    /* Modified by z00359541 for MSCC_IMSA_SERVICE_CHANGE_IND 接口调整, 2016-4-11, end */
