...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLastTmsi_SwitchOn
 功能描述  : 获取NV项中记录的上一次的Tmsi
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 返回存储开机前NV中保存的Tmsi的内容的首地址
...
VOS_UINT8* NAS_MMC_GetLastTmsi_SwitchOn(VOS_VOID)
{
    ...
    /* 返回存储开机前NV中保存的TMSI的内容的首地址 */
    return pstNasMmcCtx->stCurFsm.unFsmCtx.stSwitchOnCtx.aucLastTmsi;
}

/*****************************************************************************
 函 数 名  : NAS_MMC_SetLastTmsi_SwitchOn
 功能描述  : 记录NV项中记录的上一次的tmsi
 输入参数  : pucTmsi 
 输出参数  : 无
 返 回 值  : 无
...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLastPtmsi_SwitchOn
 功能描述  : 获取NV项中记录的上一次的Ptmsi
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 返回存储开机前NV中保存的Ptmsi的内容的首地址
...
VOS_UINT8* NAS_MMC_GetLastPtmsi_SwitchOn(VOS_VOID)
{
    ...
    /* 返回存储开机前NV中保存的PTMSI的内容的首地址 */
    return pstNasMmcCtx->stCurFsm.unFsmCtx.stSwitchOnCtx.aucLastPtmsi;
}

/*****************************************************************************
 函 数 名  : NAS_MMC_SetLastPtmsi_SwitchOn
 功能描述  : 记录NV项中记录的上一次的Ptmsi
 输入参数  : pucPtmsi 
 输出参数  : 无
 返 回 值  : 存储开机前NV中保存的Ptmsi的内容
...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLastLai_SwitchOn
 功能描述  : 获取NV项中记录的上一次的Lai
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 返回存储开机前NV中保存的Lai的内容的首地址
...
VOS_UINT8* NAS_MMC_GetLastLai_SwitchOn(VOS_VOID)
{
    ...
    /* 返回存储开机前NV中保存的LAI的内容的首地址 */
    return pstNasMmcCtx->stCurFsm.unFsmCtx.stSwitchOnCtx.aucLastLai;
}

/*****************************************************************************
 函 数 名  : NAS_MMC_SetLastLai_SwitchOn
 功能描述  : 记录NV项中记录的上一次的LAI
 输入参数  : pucLai
 输出参数  : 无
 返 回 值  : 无
...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLastRai_SwitchOn
 功能描述  : 获取NV项中记录的上一次的Lai
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 返回存储开机前NV中保存的Rai的内容的首地址
...
VOS_UINT8* NAS_MMC_GetLastRai_SwitchOn(VOS_VOID)
{
    ...
    /* 返回存储开机前NV中保存的RAI的内容的首地址 */
    return pstNasMmcCtx->stCurFsm.unFsmCtx.stSwitchOnCtx.aucLastRai;
}

/*****************************************************************************
 函 数 名  : NAS_MMC_SetLastRai_SwitchOn
 功能描述  : 记录NV项中记录的上一次的RAI
 输入参数  : pucRai
 输出参数  : 无
 返 回 值  : 无
...
/*****************************************************************************
 函 数 名  : NAS_MML_IsLteSearched_AreaLost
 功能描述  : LTE掉网时，判断是否搜索过LTE
 输出参数  : 无
 返 回 值  : VOS_BOOL
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetCampPosition
 功能描述  : 获得当前位置
 输入参数  : NAS_MSCC_PIF_CAMP_POSITION*         pstCampPosition
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetCountryCode_PlmnSelection
 功能描述  : 获取当前驻留小区的国家码给接入层
 输入参数  : 无
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MML_GetLastAreaLostPlmnCnt
 功能描述  : 获取上次掉网PLMN的掉网次数
 输入参数  : NAS_MML_PLMN_WITH_CNT_AND_RAT_STRU *
 输出参数  : 无
 返 回 值  : VOS_UINT8
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MMC_UpdateLastAreaLostPlmnWIthRatAndCnt
 功能描述  : 更新上次掉网的PLMNID 信息和次数
 输入参数  : NAS_MML_PLMN_WITH_CNT_AND_RAT_STRU* 状态机上下文中保存上次驻留网络的PLMNID地址
             NAS_MML_PLMN_ID_STRU* 当前PLMNID
 输出参数  : 无
 返 回 值  : 无
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MMC_IsGuRrcSearchedAreaLostPlmn
 功能描述  : 判断GU接入层在掉网时是否搜过当前PLMN网络
 输入参数  : RRMM_AREA_LOST_IND_STRU*
 输出参数  : 无
...
/*****************************************************************************
 函 数 名  : NAS_MMC_IsLmmSearchedAreaLostPlmn
 功能描述  : 判断LTE接入层在掉网时是否搜过当前PLMN网络
 输入参数  : LMM_MMC_AREA_LOST_IND_STRU*
 输出参数  : 无
 返 回 值  : VOS_TRUE/VOS_FALSE
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLastAreaLostPLmnInfoCtx_PlmnSelection
 功能描述  : 获取搜状态机中保存上次掉网PLMN的地址
 输入参数  : 无
 输出参数  : 无
 返 回 值  : NAS_MML_PLMN_WITH_CNT_AND_RAT_STRU*
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : NAS_MMC_GetLastAreaLostPLmnInfoCtx_BgPlmnSearch
 功能描述  : 获取背景搜状态机上下文中保存上次掉网PLMN信息的地址
 输入参数  : 无
 输出参数  : 无
 返 回 值  : NAS_MML_PLMN_WITH_CNT_AND_RAT_STRU*
 调用函数  :
