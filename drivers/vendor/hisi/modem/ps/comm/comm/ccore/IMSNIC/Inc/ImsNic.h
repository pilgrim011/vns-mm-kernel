...
#define IMS_NIC_MAX_IPPKT_LEN              (1500)                       /* IMS虚拟网卡限定上行最大IP包长度，不能大于虚拟网卡上行发送缓存大小IMS_NIC_UL_SEND_BUFF_SIZE */
#define IMS_NIC_DL_MAX_IPPKT_LEN           (1800)                       /* IMS虚拟网卡限定下行最大IP包长度，增强兼容性，VISP要求不能超过2000 */
