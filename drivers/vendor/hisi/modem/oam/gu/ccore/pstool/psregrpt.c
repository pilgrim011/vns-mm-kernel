...
#ifndef REG_BIT_N
#define REG_BIT_N(num)                  ((VOS_UINT32)0x01 << (num))
#endif
    ...
    for (i = 0; i < MODEM_ID_BUTT; i++)
    {
        for (j = 0; j < PS_REG_BBP_TRIG_MODE_BUTT; j++)
        {
            if (VOS_TRUE == g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[i][j].ulGUCBBPTrigEnable)
            {
                ...
                /* 这里是寄存器的偏移个数，不是偏移地址 */
                ulAddr  += g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[i][j].ulGUCBBPTrigNumber;
            }
        }
    }
...
VOS_VOID PsRegGUCBBPDbgBackup(MODEM_ID_ENUM_UINT16 enModemId, VOS_RATMODE_ENUM_UINT32 enMode)
{
    ...
    /* 备份CFG */
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigCFGRegVal   = HPA_Read32Reg(DBG_TRIG_W1_CONFIG1_ADDR);
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigInfoRegVal  = HPA_Read32Reg(DBG_TRIG_W1_CONFIG2_ADDR);

    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigCFGRegVal     = HPA_Read32Reg(DBG_TRIG_G1_CONFIG1_ADDR);
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigInfoRegVal    = HPA_Read32Reg(DBG_TRIG_G1_CONFIG2_ADDR);

    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigCFGRegVal    = HPA_Read32Reg(DBG_TRIG_C1_CONFIG1_ADDR);
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigInfoRegVal   = HPA_Read32Reg(DBG_TRIG_C1_CONFIG2_ADDR);

#if ( FEATURE_MULTI_MODEM == FEATURE_ON )
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigCFGRegVal   = HPA_Read32Reg(DBG_TRIG_W2_CONFIG1_ADDR);
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigInfoRegVal  = HPA_Read32Reg(DBG_TRIG_W2_CONFIG2_ADDR);

    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigCFGRegVal     = HPA_Read32Reg(DBG_TRIG_G2_CONFIG1_ADDR);
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigInfoRegVal    = HPA_Read32Reg(DBG_TRIG_G2_CONFIG2_ADDR);

    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigCFGRegVal    = HPA_Read32Reg(DBG_TRIG_C2_CONFIG1_ADDR);
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigInfoRegVal   = HPA_Read32Reg(DBG_TRIG_C2_CONFIG2_ADDR);
...
VOS_VOID PsRegGUCBBPDbgRestore(MODEM_ID_ENUM_UINT16 enModemId, VOS_RATMODE_ENUM_UINT32 enMode)
{
    ...
    /* 恢复CFG，要求先恢复CONFIG2再恢复CONFIG1 */
    HPA_Write32Reg(DBG_TRIG_W1_CONFIG2_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigInfoRegVal);
    HPA_Write32Reg(DBG_TRIG_W1_CONFIG1_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigCFGRegVal);

    HPA_Write32Reg(DBG_TRIG_G1_CONFIG2_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigInfoRegVal);
    HPA_Write32Reg(DBG_TRIG_G1_CONFIG1_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigCFGRegVal);

    HPA_Write32Reg(DBG_TRIG_C1_CONFIG2_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigInfoRegVal);
    HPA_Write32Reg(DBG_TRIG_C1_CONFIG1_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigCFGRegVal);

#if ( FEATURE_MULTI_MODEM == FEATURE_ON )
    HPA_Write32Reg(DBG_TRIG_W2_CONFIG2_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigInfoRegVal);
    HPA_Write32Reg(DBG_TRIG_W2_CONFIG1_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigCFGRegVal);

    HPA_Write32Reg(DBG_TRIG_G2_CONFIG2_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigInfoRegVal);
    HPA_Write32Reg(DBG_TRIG_G2_CONFIG1_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigCFGRegVal);

    HPA_Write32Reg(DBG_TRIG_C2_CONFIG2_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigInfoRegVal);
    HPA_Write32Reg(DBG_TRIG_C2_CONFIG1_ADDR, g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigCFGRegVal);
...
VOS_VOID PsRegGUCBBPInit( VOS_VOID )
{
    ...
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigCFGRegVal   = 0;
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigInfoRegVal  = 0;
    ...
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigCFGRegVal     = 0;
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigInfoRegVal    = 0;
    ...
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigCFGRegVal    = 0;
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_0][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigInfoRegVal   = 0;
    ...
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigCFGRegVal   = 0;
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_WCDMA].ulGUCBBPTrigInfoRegVal  = 0;
    ...
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigCFGRegVal     = 0;
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_GSM].ulGUCBBPTrigInfoRegVal    = 0;
    ...
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigCFGRegVal    = 0;
    g_stPsRegGUCBBPTrigInfo.stModeTrigInfo[MODEM_ID_1][PS_REG_BBP_TRIG_MODE_CDMA].ulGUCBBPTrigInfoRegVal   = 0;
