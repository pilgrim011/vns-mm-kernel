    ...
    USIMM_CMDHEADER_REQ_STRU            *pMsg)
{
    ...
    {
        USIMM_NORMAL_LOG("USIMM_RefreshHandle: The Card Need Reset.");
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_PinStatusCheck: enAppType is Error");
    ...
    switch (enCmdType)
    {
            ...
            if (USIMM_PIN == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin1Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: Need PUK, PIN enable is not allow");
                }
                ...
                else
                {
                    ...
                    *pulResult = USIMM_SIM_FAILURE;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_ENABLE PIN Status is Error");
                }
            }
            else if (USIMM_PIN2 == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin2Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK2_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: Need PUK2, PIN2 enable is not allow");
                }
                ...
                else
                {
                    ...
                    *pulResult = USIMM_SIM_FAILURE;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_ENABLE PIN2 Status is Error");
                }
            }
            else
            {
                *pulResult = USIMM_OPERATION_NOT_ALLOW;
                ...
                USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_ENABLE enPINType is Error");
            }
            break;
        ...
        case USIMM_PINCMD_VERIFY:
            if (USIMM_PIN == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin1Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: Need PUK, PIN Verify is not allow");
                }
                else if ((USIMM_PIN_DISABLED == pstPin1Info->enPinEnable)
                    ||(USIMM_PIN_NONEED == pstPin1Info->enPinVerified))
                {
                    ...
                    *pulResult = USIMM_OPERATION_NOT_ALLOW;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: No Need PIN, PIN Verify is not allow");
                }
                else
                {
                    ulResult = VOS_TRUE;
            ...
            else if (USIMM_PIN2 == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin2Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK2_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: Need PUK2, PIN2 Verify is not allow");
                }
                else if ((USIMM_PIN_DISABLED == pstPin2Info->enPinEnable)
                    ||(USIMM_PIN_NONEED == pstPin2Info->enPinVerified))
                {
                    ...
                    *pulResult = USIMM_OPERATION_NOT_ALLOW;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: No Need PIN2, PIN2 Verify is not allow");
                }
                else
                {
                    ulResult = VOS_TRUE;
            ...
            else
            {
                *pulResult = USIMM_OPERATION_NOT_ALLOW;
                ...
                USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_VERIFY enPINType is error");
            }
            break;
            ...
            if (USIMM_PIN == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin1Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: Need PUK, PIN Disable is not allow");
                }
                ...
                else
                {
                    ...
                    *pulResult = USIMM_SIM_FAILURE;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: PIN Disable PIN status is error");
                }
            }
            else if (USIMM_PIN2 == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin2Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK2_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: Need PUK2, PIN2 Disable is not allow");
                }
                ...
                else
                {
                    ...
                    *pulResult = USIMM_SIM_FAILURE;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_DISABLE PIN2 status is error");
                }
            }
            else
            {
                *pulResult = USIMM_OPERATION_NOT_ALLOW;
                ...
                USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_DISABLE enPINType is error");
            }
            break;
                ...
                if (USIMM_PIN == enPINType)
                {
                    ...
                    else
                    {
                        ...
                        *pulResult = USIMM_OPERATION_NOT_ALLOW;
                        ...
                        USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_UNBLOCK PUK no need");
                    }
                }
                else if (USIMM_PIN2 == enPINType)
                {
                    ...
                    else
                    {
                        ...
                        *pulResult = USIMM_OPERATION_NOT_ALLOW;
                        ...
                        USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_UNBLOCK PUK2 no need");
                    }
                }
                else
                {
                    ...
                    *pulResult = USIMM_OPERATION_NOT_ALLOW;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_UNBLOCK enPINType is error");
                }
            }
            break;
            ...
            if (USIMM_PIN == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin1Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_CHANGE Need PUK");
                }
                else if (USIMM_PIN_ENABLED == pstPin1Info->enPinEnable)
                {
                    ulResult = VOS_TRUE;
                ...
                else
                {
                    ...
                    *pulResult = USIMM_SIM_FAILURE;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_CHANGE PIN Status is error"); 
                }
            }
            else if (USIMM_PIN2 == enPINType)
            {
                if (USIMM_PUK_NEED == pstPin2Info->enPinVerified)
                {
                    ...
                    *pulResult = USIMM_SIM_PUK2_REQUIRED;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_CHANGE Need PUK2");
                }
                else if (USIMM_PIN_ENABLED == pstPin2Info->enPinEnable)
                {
                    ulResult = VOS_TRUE;
                ...
                else
                {
                    ...
                    *pulResult = USIMM_SIM_FAILURE;
                    ...
                    USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_CHANGE PIN2 status is error");
                }
            }
            else
            {
                ...
                *pulResult = USIMM_SIM_FAILURE;
                ...
                USIMM_WARNING_LOG("USIMM_PinStatusCheck: USIMM_PINCMD_CHANGE enPINType is error");
            }
            break;
        ...
        default:
            *pulResult = USIMM_OPERATION_NOT_ALLOW;
            ulResult = VOS_FALSE;
            USIMM_WARNING_LOG("USIMM_PinStatusCheck: PIN Cmd is error");
            break;
    }
...
)
{
            ...
            &&(USIMM_PINCMD_DISABLE == pstMsg->enCmdType))
    {
        ...
        {
            USIMM_WARNING_LOG("USIMM_PinPreProcHandle: Disable PIN is OFF");
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_BuildPrePinInfo: pstPINInfo is Null Ptr");
    ...
    if ((VOS_NULL_PTR == pstPin1Info)
       ||(VOS_NULL_PTR == pstPin2Info))
    {
        USIMM_ERROR_LOG("USIMM_BuildPrePinInfo: enAppType is error");
    ...
    USIMM_CMDHEADER_REQ_STRU            *pMsg)
{
    ...
    if (VOS_NULL_PTR == pstPinInfo)
    {
        USIMM_ERROR_LOG("USIMM_PINHandle: enAppType is Error");
...
VOS_UINT32 USIMM_IccProtectFirstStep(VOS_VOID)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_IccProtectFirstStep: mdrv_sci_deact Card Error");
    }
    ...
    if (VOS_OK != ulResult)
    {
        USIMM_ERROR_LOG("USIMM_IccProtectFirstStep: Select DFGSM/DFCDMA is Failed");     /*打印错误*/
...
VOS_UINT32 USIMM_UiccProtectFirstStep(VOS_VOID)
{
    ...
    if (VOS_OK != mdrv_sci_deact())
    {
        USIMM_ERROR_LOG("USIMM_UiccProtectFirstStep: mdrv_sci_deact Card Error");
    }
...
VOS_UINT32 USIMM_UiccProtectResumeAppStep(VOS_VOID)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_UiccProtectResumeAppStep: Select ADF is Failed");
    ...
    if (USIMM_INITSTEPS_SUCCESS != ulRslt)
    {
        USIMM_ERROR_LOG("USIMM_UiccProtectResumeAppStep: Init PIN is Failed");
    ...
    if (USIMM_INITSTEPS_SUCCESS == USIMM_COMM_InitAppState(0))
    {
        if (USIMM_CARD_STATE_CHANGED == USIMM_CCB_GetAppStateChange(enMainAppType))
        {
            USIMM_WARNING_LOG("USIMM_UiccProtectResumeAppStep: App State is changed after auto verify PIN");
        }
    }
...
VOS_UINT32 USIMM_UiccProtectReactiveChannels(VOS_VOID)
{
    ...
    for (i = 1; i <= ucMaxValidChannelNo; i++)
    {
        ...
        {
            USIMM_ERROR_LOG("USIMM_UiccProtectReactiveChannels: USIMM_SendOpenChannelApdu is failed");
        ...
        if (VOS_OK != ulRslt)
        {
            USIMM_ERROR_LOG("USIMM_UiccProtectReactiveChannels:Init logic ADF is failed");
            return USIMM_COMM_INIT_NORMAL_FAIL;
        }
    }
    ...
    USIMM_CMDHEADER_REQ_STRU            *pstMsg)
{
    ...
    if (VOS_OK != ulResult)
    {
        ...
        USIMM_WARNING_LOG("USIMM_ProtectReset: USIMM_DeactiveRealCard");
...
VOS_VOID USIMM_CardErrorLogReport(VOS_VOID)
{
    ...
    /* 分配消息内存  */
    pstCnfMsg = (OM_ERR_LOG_REPORT_CNF_STRU*)VOS_AllocMsg(WUEPS_PID_USIM, 
                                                            (sizeof(OM_ERR_LOG_REPORT_CNF_STRU)
                                                              - VOS_MSG_HEAD_LENGTH
                                                              - 4
    ...
    g_stCardErrorLog.stMNTNBaseAppInfo.enAppType
            = g_astUSIMMCardAppInfo[USIMM_BASE_CHANNEL_NUM].enAppType;

    g_stCardErrorLog.stMNTNBaseAppInfo.enCardService 
            = g_astUSIMMCardAppInfo[USIMM_BASE_CHANNEL_NUM].enAppService;

    g_stCardErrorLog.stMNTNLogi1AppInfo.enAppType
            = g_astUSIMMCardAppInfo[USIMM_BASE_CHANNEL_NUM+1].enAppType;

    g_stCardErrorLog.stMNTNLogi1AppInfo.enCardService 
            = g_astUSIMMCardAppInfo[USIMM_BASE_CHANNEL_NUM+1].enAppService;
    ...
    g_stCardErrorLog.stHeader.ulAlmLength = (sizeof(USIMM_MNTN_INFODATA_STRU)*USIMM_MNTN_MODULE_BUTT) 
                                            + (sizeof(USIMM_MNTN_APPINFO_STRU)*2)
    ...
    VOS_UINT16                          usInfo2)
{
    ...
    pstInfoData->astModuleInfo[ulIndex].ucErrorInfo   = ucErrorInfo;
    pstInfoData->astModuleInfo[ulIndex].ucInfo1       = ucInfo1;
    pstInfoData->astModuleInfo[ulIndex].usInfo2       = usInfo2;
    pstInfoData->astModuleInfo[ulIndex].ulSlice       = OM_GetSlice();
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_SelectFile:App Type Service is error.");
    ...
    if (VOS_OK != ulResult)
    {
        USIMM_ERROR_LOG("USIMM_SelectFile:Input path No MF.");
    ...
    pstCurfile = USIMM_CCB_GetCurFileInfo(enAppType);

    if (VOS_NULL_PTR == pstCurfile)
    {
        USIMM_ERROR_LOG("USIMM_SelectFile: USIMM_CCB_GetCurFileInfo error.");
    ...
    ulResult = USIMM_CardFilePathCMP(ulPathLen,
                                     ausFilePath,
                                     pstCurfile->usFilePathLen,
                                     pstCurfile->ausFilePath);
    ...
    if (VOS_OK == ulResult)
    {
        ...
        {
            USIMM_NORMAL_LOG("USIMM_SelectFile: Selected file is current file.");
    ...
    if (VOS_NULL == usCurPathLen)
    {
        ...
        USIMM_NORMAL_LOG("USIMM_SelectFile: USIMM_ClearCurFileInfo.");
    }
    else
    {
        ...
        /* 更新路径 */
        USIMM_UpdateFilePath(&stSelectPara, &stFilePath, pstCurfile);

        USIMM_NORMAL_LOG("USIMM_SelectFile: USIMM_UpdateFilePath.");
    }
...
)
{
      ...
      ||(USIMM_SW_NOFILE_SELECT     == ulResult))
    {
        ...
        USIMM_WARNING_LOG("USIMM_GetFileCommHandle: Need retry to read file");
    ...
    VOS_UINT16                          usEFID)
{
    ...
    if (VOS_TRUE == USIMM_CCB_GetUsimSimulateIsimStatus())
    {
        ...
        {
            /* 文件不可更新 */
            USIMM_WARNING_LOG("USIMM_GetIsimFileHandle: Change ISIM file ID error.");
        ...
        {
            /* 文件不可读取 */
            USIMM_WARNING_LOG("USIMM_GetIsimFileHandle: ISIM file ID can't change");
    ...
    USIMM_CMDHEADER_REQ_STRU            *pMsg)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_RAccessHandle: USIMM_AccessCmdHandle return USIMM_SW_SENDCMD_ERROR");
    ...
    if (VOS_YES == ulNeedCopy) /*有数据拷贝*/
    {
        ...
        if ((VOS_FALSE              == USIMM_CheckSupportAP())
            &&(USIMM_GET_RESPONSE   == pstMsg->enCmdType))
        {
    ...
    USIMM_CMDHEADER_REQ_STRU            *pMsg)
{
    ...
    if (VOS_TRUE == USIMM_VsimIsActive())    /*vSIM功能打开*/
    {
        USIMM_WARNING_LOG("USIMM_PBInitStatusIndHandle: The vSIM is Open");
    ...
    USIMM_AUTHENTICATION_REQ_STRU       *pstMsg)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_SIMAuthHandle: Card status is absent.");
    ...
    USIMM_AUTHENTICATION_REQ_STRU       *pstMsg)
{
    ...
    if (USIMM_CARD_SERVIC_ABSENT == USIMM_CCB_GetAppService(USIMM_GUTL_APP))
    {
        USIMM_ERROR_LOG("USIMM_USIMAuthHandle:Card status is absent.");
    ...
    USIMM_AUTHENTICATION_REQ_STRU       *pstMsg)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_IsimAuthenticationProc: ISIM is Absent.");
    ...
    if (USIMM_SW_AUTN_ERROR == ulResult)
    {
        USIMM_ERROR_LOG("USIMM_IsimAuthenticationProc: Check SW Error");
    ...
    USIMM_APDU_RSP_STRU                *pstRspData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_IsimAkaAuthRspProc: Response Data Error");
    ...
    USIMM_APDU_RSP_STRU                *pstRspData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_IsimHttpAuthRspProc: Response Data Error");
    ...
    USIMM_APDU_RSP_STRU                *pstRspData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_IsimGbaAuthRspProc: Response Data Error");
    ...
    USIMM_APDU_RSP_STRU                *pstRspData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_IsimNafAuthRspProc: Response Data Error");
    ...
    VOS_UINT8                           *pucMode)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_ISIMAuthParaCheck: USIM_SVR_ACCESS_IMS not disable");
    ...
    USIMM_AUTHENTICATION_REQ_STRU       *pstMsg)
{
    ...
    if (USIMM_CARD_SERVIC_ABSENT == USIMM_CCB_GetAppService(USIMM_IMS_APP))
    {
        USIMM_ERROR_LOG("USIMM_ISIMAuthHandle: USIMM_IMS_APP is disable.");
    ...
    {
        USIMM_ERROR_LOG("USIMM_ISIMAuthHandle: USIMM_ISIMAuthParaCheck is wrong.");
    ...
    if (USIMM_SW_AUTN_ERROR == ulResult)
    {
        USIMM_WARNING_LOG("USIMM_ISIMAuthHandle: Check SW is USIMM_SW_AUTN_ERROR");
    ...
    USIMM_ERROR_LOG("USIMM_ISIMAuthHandle: Response Data Error");
    ...
    USIMM_AUTHENTICATION_REQ_STRU       *pstMsg)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_CdmaAuthHandle: Card status is absent.");
    ...
    if (VOS_OK != USIMM_AuthenticationDataFillDataProc(pstMsg, &stData))
    {
        USIMM_ERROR_LOG("USIMM_CdmaAuthHandle: USIMM_AuthenticationDataFillDataProc is fail.");
    ...
    {
        USIMM_WARNING_LOG("USIMM_CdmaAuthHandle: Check SW is USIMM_SW_CDMA_AUTN_ERROR");
    ...
    USIMM_FDNPROCESS_REQ_STRU           *pstMsg)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_3Gpp2FDNHandle: Card Status is Wrong");
    ...
    USIMM_FDNPROCESS_REQ_STRU           *pstMsg)
{
    ...
    if (USIMM_CARD_SERVIC_AVAILABLE != USIMM_CCB_GetAppService(USIMM_GUTL_APP))
    {
        USIMM_ERROR_LOG("USIMM_3GppFDNHandle: Card Status is Wrong");
    ...
    {
        USIMM_ERROR_LOG("USIMM_3GppFDNHandle: The Card SVR is Wrong");
    ...
    USIMM_MsgBlock                      *pMsg)
{
    ...
    if (USIMM_OPENSPEEDENABLE == USIMM_CCB_GetUsimOpenSpeed())/*卡状态检查*/
    {
        USIMM_WARNING_LOG("USIMM_DeactiveCardReq: OpenSpeed is ON");
    ...
    if (VOS_OK != mdrv_sci_deact())
    {
        USIMM_ERROR_LOG("USIMM_DeactiveRealCard: mdrv_sci_deact Deactive Card Error");
    }
    ...
    USIMM_CMDHEADER_REQ_STRU            *pMsg)
{
    ...
    if (VOS_OK != ulResult)
    {
        ...
        USIMM_RecordCardErrorLog(USIMM_MNTN_MODULE_INIT,
                                ...
                                USIMM_MNTN_INIT_CARDERR,
                                VOS_NULL,
                                USIMM_MNTN_ERROR_LEVEL_MAJOR);
#endif  /*(FEATURE_ON == FEATURE_PTM)*/

        USIMM_ERROR_LOG("USIMM_InitCardHandle: Init handle fail");
    }
    ...
    USIMM_CMDHEADER_REQ_STRU            *pMsg)
{
    ...
    if (USIMM_SW_OK != ulResult)
    {
        USIMM_WARNING_LOG("USIMM_OpenChannelHandle: USIMM_SelectAIDFile failed.");
    ...
    USIMM_CMDHEADER_REQ_STRU            *pstMsgHeader)
{
    ...
    if (USIMM_UNLIMIT_APP_BUTT <= pstReadMsg->stMsgHeader.enAppType)
    {
        ...
        USIMM_WARNING_LOG("USIMM_ReadFileHandle: enAppType is wrong");
    ...
    if (USIMM_EF_FILE != USIMM_GetFileIDFromStr(&pstReadMsg->stFilePath, &usEFID))
    {
        ...
        USIMM_WARNING_LOG("USIMM_ReadFileHandle: USIMM_GetFileIDFromStr is fail");
    ...
    if(VOS_OK != USIMM_ApiParaCheckSimple())
    {
        ...
        USIMM_WARNING_LOG("USIMM_ReadFileHandle: USIMM_ApiParaCheckSimple is fail");
    ...
    USIMM_CMDHEADER_REQ_STRU            *pstMsgHeader)
{
    ...
    if (VOS_OK != USIMM_ApiParaCheckSimple())
    {
        ...
        USIMM_WARNING_LOG("USIMM_UpdateFileHandle: USIMM_ApiParaCheckSimple is fail");
    ...
    if (USIMM_UNLIMIT_APP_BUTT <= pstUpdateMsg->stMsgHeader.enAppType)
    {
        ...
        USIMM_WARNING_LOG("USIMM_UpdateFileHandle: enAppType is Wrong");
    ...
    if (USIMM_EF_FILE != USIMM_GetFileIDFromStr(&pstUpdateMsg->stFilePath, &usEFID))
    {
        ...
        USIMM_WARNING_LOG("USIMM_UpdateFileHandle: USIMM_GetFileIDFromStr is fail");
    ...
    VOS_UINT16                          usEFID)
{
    ...
    if (USIMM_SW_OK != ulResult)
    {
        USIMM_WARNING_LOG("USIMM_SetFileCommHandle: USIMM_UpdateFile is Failed");
    ...
    if (VOS_OK != USIMM_PoolUpdateOneFile(pstUpdateMsg->stMsgHeader.enAppType,
                                          ...
                                          pstUpdateMsg->aucContent))
    {
        USIMM_WARNING_LOG("USIMM_SetFileCommHandle: USIMM_PoolUpdateOneFile is Failed");
    }
    ...
    USIMM_CMDHEADER_REQ_STRU            *pstMsgHeader)
{
    ...
    if (USIMM_API_SUCCESS != USIMM_ApiParaCheck())
    {
        ...
        USIMM_WARNING_LOG("USIMM_QueryFileHandle: USIMM_ApiParaCheck is Failed");
    ...
    if (USIMM_EF_FILE != USIMM_GetFileIDFromStr(&pstQueryFileReq->stFilePath, &usEFID))
    {
        ...
        USIMM_WARNING_LOG("USIMM_QueryFileHandle: USIMM_GetFileIDFromStr is Failed");
    ...
    USIMM_CMDHEADER_REQ_STRU            *pstMsgHeader)
{
    ...
    if (VOS_OK != USIMM_ApiParaCheckSimple())
    {
        ...
        USIMM_WARNING_LOG("USIMM_GetMaxRecordNum: USIMM_ApiParaCheckSimple is Fail");
    ...
    if (USIMM_UNLIMIT_APP_BUTT <= pstSearchMsg->stMsgHeader.enAppType)
    {
        ...
        USIMM_WARNING_LOG("USIMM_GetMaxRecordNum: enAppType is Wrong");
    ...
    if (USIMM_EF_FILE != USIMM_GetFileIDFromStr(&pstSearchMsg->stFilePath, &usEFID))
    {
        ...
        USIMM_WARNING_LOG("USIMM_GetMaxRecordNum: USIMM_GetFileIDFromStr is Fail");
    ...
    USIMM_CMDHEADER_REQ_STRU            *pstMsgHeader)
{
    ...
    for (i = 0; i < pstMsg->ulFileCount; i++)
    {
                                       ...
                                       &(pstMsg->stFileData[i].stFilePath)))
        {
            ...
            USIMM_WARNING_LOG("USIMM_SetSPBFileReq: USIMM_SelectFile is Fail");
        ...
        if (VOS_OK != ulResult)
        {
            ...
            USIMM_WARNING_LOG("USIMM_SetSPBFileReq: USIMM_UpdateFile is Fail");
    ...
    USIMM_SENDTPDUDATA_REQ_STRU         *pstMsg)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_ChannelCmdParaCheck: The INS is Wrong.");
    ...
    */
    if (VOS_TRUE == g_stUsimmFeatureCfg.unCfg.stFeatureCfg.ulCglaInsCheckFlg)
    {
        ...
        {
            USIMM_WARNING_LOG("USIMM_ChannelCmdParaCheck: The INS does not support.");
    ...
    if (VOS_TRUE == g_stUsimmFeatureCfg.unCfg.stFeatureCfg.ulCglaSelectCheckFlg)
    {
        ...
        {
            USIMM_WARNING_LOG("USIMM_ChannelCmdParaCheck: The Select P1 does not support.");
    ...
    USIMM_SENDTPDU_CNFINFO_STRU         *pstDataCnf)
{
    ...
    USIMM_WARNING_LOG("USIMM_CheckAIDFcp: Get ADF Fcp Fail");
...
)
{
    ...
    USIMM_CURFILEINFO_ST               *pstCurFile;
    USIMM_COMM_CARD_APP_INFO_STRU      *pstCommCardAppInfo;

    (VOS_VOID)VOS_MemSet(&stFilePath, 0, sizeof(USIMM_U16_LVDATA_STRU));
    ...
    pstCommCardAppInfo = USIMM_CCB_GetAppInfoByCH(stTpduHead.ucChannel);
    ...
    if (USIMM_SW_SENDCMD_ERROR == ulResult)
    {
        USIMM_ERROR_LOG("USIMM_SelectTPDUProc: The USIMM_SendTPDUHandle Send Error");

        return VOS_OK;
    }

    /* 如果激活AID成功，需要更新当前CHANNEL的 AID 如果是terminnate aid 需要将全局变量的 长度清0 */
    if ((USIMM_SELECT_ACTIVATE_AID  == pstMsg->stTPDUData.aucTPDUHead[P2])
     && (USIMM_SELECT_BY_DF_NAME    == pstMsg->stTPDUData.aucTPDUHead[P1])
     && (0XA0                       != pstMsg->stTPDUData.aucTPDUHead[CLA]))
    {
        ausPath[0]                  = 0x7fff;
        stFilePath.pusData          = ausPath;
        stFilePath.ulDataLen        = 1;
        pstCommCardAppInfo->stAdfInfo.ulAIDLen = stTpduHead.ucP3;
        (VOS_VOID)VOS_MemCpy(pstCommCardAppInfo->stAdfInfo.aucAID, stTpduData.pucData, stTpduHead.ucP3);
    }
    else if ((USIMM_SELECT_TERMINATION_AID  == pstMsg->stTPDUData.aucTPDUHead[P2])
        &&   (USIMM_SELECT_BY_DF_NAME       == pstMsg->stTPDUData.aucTPDUHead[P1])
        &&   (0XA0                          != pstMsg->stTPDUData.aucTPDUHead[CLA]))
    {
        ausPath[0]                  = 0x7fff;
        stFilePath.pusData          = ausPath;
        stFilePath.ulDataLen        = 1;
        pstCommCardAppInfo->stAdfInfo.ulAIDLen = VOS_NULL;
    }
    else if  (USIMM_SW_OK == ulResult)
    {
    ...
    {
        USIMM_WARNING_LOG("USIMM_SelectTPDUProc: The USIMM_SendTPDUHandle SW Error");
    }
    ...
    else
    {
        ...
        USIMM_CCB_ClearResponse(stTpduHead.ucChannel);
    }
...
)
{
    ...
    if (VOS_NULL_BYTE == ucChannelNo)
    {
        USIMM_WARNING_LOG("USIMM_GetResponseTPDUProc: The USIMM_CCB_GetAppChNO is Fail");
    ...
    USIMM_CMDHEADER_REQ_STRU            *pstMsgHeader)
{
    ...
    USIMM_APDU_RSP_STRU                 stRspData;
    VOS_UINT32                          ulApduSwRet;
    VOS_UINT32                          ulRspLen    = 0;
    ...
    /*  如果期望返回最终的sw，需要将get resp发给卡，如果是德电需求，取全局变量的内容 */
    else if ((CMD_INS_GET_RESPONSE == pstMsg->stTPDUData.aucTPDUHead[INS])
          /*added by c00299064 DTS2016032602885 d00260379 德电NFC用例 begin*/
          && (VOS_NULL != ulRspLen))
          /*added by c00299064 DTS2016032602885 d00260379 德电NFC用例 begin*/
    {
    ...
    if (VOS_OK == ulResult)
    {
        ulApduSwRet = USIMM_CheckSW(pstMsg->stTPDUData.aucTPDUHead[INS],
                                    stRspData.ucApduSW1,
                                    stRspData.ucApduSW2);
        /* 如果不是WARNNING 直接返回最终的值
           如果是WARNNING data ind  需要返回最终的sw
           如果是warnning    不是 data ind 需要返回中间的的值 */
        /*added by c00299064 DTS2016032602885 d00260379 德电NFC用例 begin*/
        if (USIMM_SW_WARNING != ulApduSwRet)
        {
        /*added by c00299064 DTS2016032602885 d00260379 德电NFC用例 end*/
            stDataCnf.ucSw1         = stRspData.ucSW1;
            stDataCnf.ucSw2         = stRspData.ucSW2;
            USIMM_WARNING_LOG ("USIMM_SendTPDUDataHandle: not warning ucSw1 ucSw2");
        }
        else if ((VOS_TRUE == g_stUsimmFeatureCfg.unCfg.stFeatureCfg.ulWarningDataInd))
        {
            stDataCnf.ucSw1         = stRspData.ucSW1;
            stDataCnf.ucSw2         = stRspData.ucSW2;
            USIMM_WARNING_LOG("USIMM_SendTPDUDataHandle: USIMM_SW_WARNING and data ind need, ucSw1 ucSw2");
        }
        else
        {
            stDataCnf.ucSw1         = stRspData.ucApduSW1;
            stDataCnf.ucSw2         = stRspData.ucApduSW2;
            USIMM_WARNING_LOG("USIMM_SendTPDUDataHandle: ucApduSW1 ucApduSW2");
        }
    ...
    USIMM_CMDHEADER_REQ_STRU            *pMsg)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_ApplicationMsgProc:Msg ID is wrong");
