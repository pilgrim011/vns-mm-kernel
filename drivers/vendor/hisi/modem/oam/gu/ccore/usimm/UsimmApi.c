...
)
{
    ...
    if (VOS_NULL_WORD == pstFilePath->ulPathLen)
    {
        USIMM_WARNING_LOG("USIMM_GetFileIDFromStr: ulPathLen is Error");
    ...
    if (VOS_OK != USIMM_AsciiToHexCode(pstFilePath->acPath, pstFilePath->ulPathLen, aucPath, &ulPathLen))
    {
       USIMM_WARNING_LOG("USIMM_GetFileIDFromStr: USIMM_AsciiToHexCode is Error");
                                        ...
                                        VOS_UINT32              *pusPathLen)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_GetFileIDFromStr: Input is Error");
...
VOS_BOOL USIMM_VsimIsActive(VOS_VOID)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_VsimIsActive:Read NV en_NV_Item_VSIM_SUPPORT_FLAG Failed.");
    ...
    USIMM_DEF_FILEID_ENUM_UINT32       *penDefFileID)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_ChangePathToDefFileID: Input Para is wrong");
    ...
    USIMM_WARNING_LOG("USIMM_ChangePathToDefFileID: The File Path is Unknow");
...
VOS_UINT32 USIMM_GetPinRemainTime(USIMM_PIN_REMAIN_STRU *pstRemainTime)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_GetPinRemainTime: enAppType is not exsit.");
...
VOS_VOID USIMM_SCICardOutNotify(VOS_UINT ulCardInOutStatus)
{
    ...
    USIMM_WARNING_LOG("USIMM_SCICardOutNotify: Receive SCI Callback");

    if (USIMM_OPENSPEEDENABLE == USIMM_CCB_GetUsimOpenSpeed())
    {
        USIMM_WARNING_LOG("USIMM_SCICardOutNotify: The CQST is Open");
...
VOS_VOID USIMM_SciCardStatusIndCbFunc(USIMM_CARDSTATUS_IND_ENUM_UINT32 enCardStatus)
{
    ...
    USIMM_WARNING_LOG("USIMM_SciCardStatusIndCbFunc: Receive SCI Callback");

    if (USIMM_OPENSPEEDENABLE == USIMM_CCB_GetUsimOpenSpeed())
    {
        USIMM_WARNING_LOG("USIMM_SciCardStatusIndCbFunc: CQST is Open");
    ...
    if (VOS_TRUE == USIMM_VsimIsActive())    /*vSIM功能打开*/
    {
        USIMM_WARNING_LOG("USIMM_SciCardStatusIndCbFunc: VSIM is Open");
    ...
    if (VOS_NULL_PTR == pstMsg)
    {
        USIMM_WARNING_LOG("USIMM_SciCardStatusIndCbFunc: VOS_AllocMsg is Failed");
...
VOS_UINT32 USIMM_GetAid(VOS_UINT32 ulAidType, VOS_UINT32 *pulLen, VOS_UINT8 *pucAid)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_GetAid: Input is Error");
    ...
    {
        USIMM_WARNING_LOG("USIMM_GetAid: ulAidType is Failed");
    ...
    VOS_BOOL                            *pbHasWGModule)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_GetCardCGType: Input is Failed");
