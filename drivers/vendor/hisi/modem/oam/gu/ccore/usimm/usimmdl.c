    ...
    VOS_UINT8                           *pucData)
{
    ...
    for(i=0; i<ulDataLen; )
    {
        if(enSendState == USIMMDL_STATE_SENDDATA)
        {
            ...
            {
                USIMM_ERROR_LOG("USIMM_DLSendDataOneByOne: mdrv_sci_send_data return Error");
        ...
        {
            USIMM_ERROR_LOG("USIMM_DLSendDataOneByOne: mdrv_sci_recv return Error");
        ...
        {
            USIMM_NORMAL_LOG("USIMM_DLSendDataOneByOne: Receive NULL Byte");
    ...
    USIMM_APDU_ST                       *pstAPDUData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_DLSendAPDU: mdrv_sci_send_data APDU Error");
    ...
    USIMM_APDU_ST                       *pstAPDUData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_DLSendData: mdrv_sci_send_data return Error");
    ...
    USIMM_APDU_ST                       *pstAPDUData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_DLReceiveACK: mdrv_sci_recv ACK Error");
    ...
    {
        USIMM_NORMAL_LOG("USIMM_DLReceiveACK:receive NULL byte");
    ...
    {
        USIMM_NORMAL_LOG("USIMM_DLReceiveACK: receive SW1, go to receive SW2");
    ...
    USIMM_APDU_ST                       *pstAPDUData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_DLReceiveData: mdrv_sci_recv return Error");
    ...
    USIMM_APDU_ST                       *pstAPDUData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_DLReceiveSW: mdrv_sci_recv receive SW Error");
    ...
    {
        USIMM_WARNING_LOG("USIMM_DLReceiveSW:Receive 6C or 67 Byte");

        gstUSIMMDLControl.ulP3ErrorTime++;

        if (USIMM_P3ERROR_MAXTIME <= gstUSIMMDLControl.ulP3ErrorTime)
        {
            USIMM_WARNING_LOG("USIMM_DLReceiveSW:Receive 6C or 67 Byte Too Many, Need Return");
        ...
        if ((VOS_TRUE == gstUSIMMDLControl.bSendRep)&&(CMD_INS_GET_RESPONSE == pstAPDUData->aucGetRepAPDU[INS]))
        {
            ...
            {
                USIMM_WARNING_LOG("USIMM_DLReceiveSW: GetResponse Receive 6C or 67 Byte Again, Need Return");
        ...
        USIMM_WARNING_LOG("USIMM_DLReceiveSW: Need Resend APDU");
    ...
    USIMM_APDU_ST                       *pstAPDUData)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_DLCglaReceiveSW: mdrv_sci_recv SW Error");
    ...
    if((USIMM_SW_P3_ERROR == ulResult)&&(0x09 != pstAPDUData->aucAPDU[INS]))   /*由于P3字节错误，改变之后重新进入新的DL流程发送*/
    {
        ...
        if ((VOS_TRUE == gstUSIMMDLControl.bSendRep)&&(CMD_INS_GET_RESPONSE == pstAPDUData->aucGetRepAPDU[INS]))
        {
            if (pstAPDUData->ucSW2 == pstAPDUData->aucGetRepAPDU[P3])
            {
                USIMM_WARNING_LOG("USIMM_DLCglaReceiveSW: GetResponse Receive 6C or 67 Byte Again");
        ...
        USIMM_NORMAL_LOG("USIMM_DLCglaReceiveSW: Restart DL Again");
	...
	&&(VOS_TRUE == g_stUsimmFeatureCfg.unCfg.stFeatureCfg.ulCglaGetRsp))
    {
        ...
        USIMM_NORMAL_LOG("USIMM_DLCglaReceiveSW: Goto GetResponse");
    }
    ...
    USIMM_APDU_ST                       *pstAPDUData)
{
    ...
    if((0x61 == pstAPDUData->ucSW1)||(0x9F == pstAPDUData->ucSW1))
    {
        ...
        if ((pstAPDUData->ulRecDataLen + ulTempLen) > USIMM_APDU_MAXLEN)
        {
            ...
            USIMM_NORMAL_LOG("USIMM_DLCglaGetResponse: Goto Idle");
