...
VOS_VOID USIMM_COMM_ClearInitCtrlGlobal(VOS_VOID)
{
    ...
    USIMM_NORMAL_LOG("USIMM_COMM_ClearInitCtrlGlobal: Clear InitCtrl Global");
...
VOS_VOID USIMM_COMM_ResetInitGlobal(VOS_VOID)
{
    ...
    USIMM_NORMAL_LOG("USIMM_COMM_ResetInitGlobal: Reset InitCtrl Global");
...
VOS_VOID USIMM_COMM_ClearAppInfoGlobal(VOS_VOID)
{
    ...
    USIMM_NORMAL_LOG("USIMM_COMM_ClearAppInfoGlobal: Clear AppInfo Global");
...
VOS_VOID USIMM_COMM_ResetInitListStatus(VOS_VOID)
{
    ...
    USIMM_NORMAL_LOG("USIMM_COMM_ResetInitListStatus: Reset Init List");
...
VOS_VOID USIMM_COMM_InitCommFuncTble(VOS_VOID)
{
    ...
    USIMM_NORMAL_LOG("USIMM_COMM_InitCommFuncTble: Init CommFunc Tble");
...
VOS_VOID USIMM_COMM_ResetPIN1Global(VOS_VOID)
{
    ...
    USIMM_NORMAL_LOG("USIMM_COMM_ResetPIN1Global: Reset PIN1 Global");
...
)
{
    ...
    {
        USIMM_NORMAL_LOG("USIMM_COMM_IsGcfSim: NV Read fail");
        return VOS_FALSE;
    }

    if (VOS_FALSE == stFlag.ulSimAtrFlag)
    {
        USIMM_NORMAL_LOG("USIMM_COMM_IsGcfSim: NV Close");
        return VOS_FALSE;
    }

    if (ulATRLen != sizeof(aucAtrStub))
    {
        USIMM_NORMAL_LOG("USIMM_COMM_IsGcfSim: Is not GCF ATR Len");
        return VOS_FALSE;
    }
    ...
    {
        USIMM_NORMAL_LOG("USIMM_COMM_IsGcfSim: Is GCF SIM");
        return VOS_TRUE;
    /*lint +e534*/
    }

    USIMM_NORMAL_LOG("USIMM_COMM_IsGcfSim: Is not GCF ATR");
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_COMM_DecodeATR(VOS_VOID)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_COMM_DecodeATR:mdrv_sci_get_atr get ATR Error");

#if (FEATURE_ON == FEATURE_PTM)
        USIMM_RecordCardErrorLog(USIMM_MNTN_MODULE_INIT,
                                USIMM_MNTN_INIT_FAIL, 
                                USIMM_MNTN_INIT_ATRERR,
                                VOS_NULL,
    ...
    if (VOS_TRUE == USIMM_COMM_IsGcfSim(aucATR, ulATRLen))
    {
        ...
        USIMM_WARNING_LOG("USIMM_COMM_DecodeATR:It's a GCF SIM");
    ...
    {
        USIMM_WARNING_LOG("USIMM_COMM_DecodeATR:USIM ATR Length Error");
    }
...
)
{
    ...
    {
        USIMM_NORMAL_LOG("USIMM_COMM_GetTerminalProfile: NV_Read OK");

        return;
    }

    USIMM_WARNING_LOG("USIMM_COMM_GetTerminalProfile: NV_Read en_NV_Item_TerminalProfile_Set Failed");
...
)
{
    ...
    if (USIMM_COMM_INIT_SUCC == enCommRslt)
    {
        ...
        USIMM_NORMAL_LOG("USIMM_COMM_InitCard: It's a UICC card");
    ...
    if (USIMM_COMM_INIT_FATAL_FAIL == enCommRslt)
    {
        ...
        USIMM_RecordCardErrorLog(USIMM_MNTN_MODULE_INIT,
                                USIMM_MNTN_INIT_FAIL, 
                                USIMM_MNTN_INIT_UICCERR,
                                VOS_NULL,
                                USIMM_MNTN_ERROR_LEVEL_MAJOR);
#endif  /*(FEATURE_ON == FEATURE_PTM)*/

        USIMM_ERROR_LOG("USIMM_COMM_InitCard: Init card fail during UICC procedure.");
    ...
    if (USIMM_COMM_INIT_SUCC == USIMM_ICC_InitCard())
    {
        ...
        USIMM_NORMAL_LOG("USIMM_COMM_InitCard: It's a ICC card");
    ...
    USIMM_CCB_SetCardType(USIMM_PHYCARD_TYPE_NOCARD);
        ...
        USIMM_RecordCardErrorLog(USIMM_MNTN_MODULE_INIT,
                                USIMM_MNTN_INIT_FAIL, 
                                USIMM_MNTN_INIT_ICCERR,
                                VOS_NULL,
                                USIMM_MNTN_ERROR_LEVEL_MAJOR);
#endif  /*(FEATURE_ON == FEATURE_PTM)*/

    USIMM_ERROR_LOG("USIMM_COMM_InitCard: Init card fail during ICC procedure.");
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_COMM_InitCardApps(VOS_VOID)
{
    ...
    if (0 == ulAppNum)
    {
        USIMM_ERROR_LOG("USIMM_COMM_InitCardApps: USIMM_COMM_GetAppInitFuncs fail.");
        return USIMM_COMM_INIT_NORMAL_FAIL;
    }
    ...
    for (i = 0; i < ulAppNum; i++)
    {
        ...
        else
        {
            ...
            {
                USIMM_ERROR_LOG("USIMM_COMM_InitCardApps: Change To ICC card");
                break;
            }
            else
            {
                USIMM_ERROR_LOG("USIMM_COMM_InitCardApps: On app fail need to reset");
    ...
    if (0 == ulSuccessNum)
    {
        USIMM_ERROR_LOG("USIMM_COMM_InitCardApps: None app Succ");
        return USIMM_COMM_INIT_NORMAL_FAIL;
    }

    USIMM_NORMAL_LOG("USIMM_COMM_InitCardApps: App Succ");
...
)
{
    switch (enResult)
    {
        ...
        case USIMM_INITSTEPS_FAIL_REMOVE:
            ...
            {
                USIMM_ERROR_LOG("USIMM_COMM_CheckInitStepResult: One app has too much fail");
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_COMM_AutoVerifyPIN: USIMM_CCB_GetAppInfoByCH fail");
    ...
    {
        USIMM_ERROR_LOG("USIMM_COMM_AutoVerifyPIN: ucPIN1No Out of range");
    ...
    {
        USIMM_ERROR_LOG("USIMM_COMM_AutoVerifyPIN: USIMM_CCB_GetPIN1InfoByRef fail");
...
)
{
    ...
    if (VOS_NULL_PTR == pstAppInfo)
    {
        USIMM_ERROR_LOG("USIMM_COMM_InitAppState: USIMM_CCB_GetAppInfoByCH fail");
        return USIMM_INITSTEPS_FAIL;
    }
    ...
    if ((ucPIN1No < 1)||(ucPIN1No > 8))
    {
        USIMM_ERROR_LOG("USIMM_COMM_InitAppState: ucPIN1No out of range");
        return USIMM_INITSTEPS_FAIL;
    }
    ...
    if (VOS_NULL_PTR == pstPIN1Info)
    {
        USIMM_ERROR_LOG("USIMM_COMM_InitAppState: USIMM_CCB_GetPIN1InfoByRef fail");
        return USIMM_INITSTEPS_FAIL;
    }
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_COMM_SaveDFPinInfo: USIMM_CCB_GetCurDFInfo fail");
    ...
    if (VOS_NULL_PTR == pstPin1Info)
    {
        USIMM_ERROR_LOG("USIMM_COMM_SaveDFPinInfo: USIMM_CCB_GetPIN1InfoByRef fail");
    ...
    {
        USIMM_ERROR_LOG("USIMM_COMM_SaveDFPinInfo: USIMM_CCB_GetPIN2InfoByApp fail");
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_COMM_StoreAppSN: enAppType error");
        return;
    }
    ...
    {
        USIMM_WARNING_LOG("USIMM_COMM_StoreAppSN: Not support IMS");
        return;
    }
#endif
    ...
    /* UE不支持CDMA则不初始化CSIM或UIM应用 */
        ...
        {
            USIMM_WARNING_LOG("USIMM_COMM_StoreAppSN: Not support CDMA");
            return;
        }
#endif
    }
...
)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_UICC_InitStoreEsnMeid: Meid no need write to card");
    ...
    USIMM_ERROR_LOG("USIMM_UICC_InitStoreEsnMeid: USIMM_SendStoreESNMEIDApdu Send error");
...
)
{
    ...
    for (i = 0; i < usFileLen; i += ucRecordLen)
    {
        ...
        /*lint +e534*/
            ...
            USIMM_NORMAL_LOG("USIMM_UICC_DecodeAppAid: Find USIM App");
        }
        ...
        /*lint +e534*/
            ...
            USIMM_NORMAL_LOG("USIMM_UICC_DecodeAppAid: Find ISIM App");
        }
        ...
        /*lint +e534*/
            ...
            USIMM_NORMAL_LOG("USIMM_UICC_DecodeAppAid: Find CSIM App");
        }
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_UICC_CUIMCheck(VOS_VOID)
{
    ...
    if (VOS_TRUE == g_stUsimmFeatureCfg.unCfg.stFeatureCfg.ulCUIMCheck)
    {
        ...
        {
            USIMM_ERROR_LOG("USIMM_UICC_CUIMCheck: NV On and no CDMA app");/*打印错误*/
            return USIMM_COMM_INIT_FATAL_FAIL;
        }

        if (VOS_NULL == pstAidInfo->ulAIDLen)
        {
            USIMM_ERROR_LOG("USIMM_UICC_CUIMCheck: NV On and ulAIDLen is NULL");/*打印错误*/
            return USIMM_COMM_INIT_FATAL_FAIL;
        }
    }
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_UICC_DecodeATRStep2(VOS_VOID)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_DecodeATRStep2:mdrv_sci_get_atr get ATR Error");
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_UICC_InsertCommFileToPool(VOS_VOID)
{
    ...
    for (i = 0; i < USIMM_INITFIRST_FILENUM; i++)
    {
        ...
        {
            USIMM_WARNING_LOG("USIMM_UICC_InsertCommFileToPool: Select 2Fxx is Failed");
        }
    }

    USIMM_CCB_SetCardVersion(USIMM_PHYCARD_TYPE_UICC);

    USIMM_NORMAL_LOG("USIMM_UICC_InsertCommFileToPool: Init Card File First Step 1 Finished");
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_UICC_InitCard(VOS_VOID)
{
    ...
    for (ulStep = 0; ulStep < ARRAYSIZE(g_aUICCCommInitProcFuncTbl); ulStep++)
    {
        ...
        {
            USIMM_ERROR_LOG("USIMM_UICC_InitCard: One step return USIMM_COMM_INIT_FATAL_FAIL");
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_UICC_SortAppSN(VOS_VOID)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_SortAppSN: NV_Read en_NV_Item_Usim_App_Priority_Cfg fail");
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_UICC_CheckCSIM(VOS_VOID)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_CheckCSIM: Feature On and CSIM is absent");
...
)
{
    ...
    if (VOS_NULL_PTR == pstAIDInfo)
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitADFInfo: USIMM_CCB_GetAIDByApp fail");
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitADFInfo: Select AID File Error");/*打印错误*/
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_UICC_InitIsimSimuState(VOS_VOID)
{
    ...
    if (USIMM_CARD_SERVIC_ABSENT != USIMM_CCB_GetAppService(USIMM_IMS_APP))
    {
        ...
        USIMM_NORMAL_LOG("USIMM_UICC_InitIsimSimuState: Support real ISIM");/*打印错误*/
     ...
     && (PS_USIM_SERVICE_AVAILIABLE == stUsimSupIms.ulUsimSupImsEnable))/*读取失败按照默认下发*/
    {
        ...
        USIMM_WARNING_LOG("USIMM_UICC_InitIsimSimuState: Support Simulate ISIM");/*打印错误*/
    }
...
)
{
    ...
    {
        USIMM_ERROR_LOG("UISMM_UICC_InitCardOpenChannel: USIMM_SendOpenChannelApdu Fail");
...
)
{
    ...
    VOS_UINT16                          ausUsimInitMFile[] = {USIMM_USIM_EFIMSI_ID,
                                                              USIMM_USIM_EFAD_ID};
    VOS_UINT16                          ausUsimRealID[] = {EFIMSI, EFAD};
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitCsimADF: Select CSIM AID is Error");/*打印错误*/
...
VOS_VOID USIMM_UICC_InitCUIMEccFile(VOS_VOID)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitCUIMEccFile: Get Cdma ECC Error");
...
VOS_VOID USIMM_UICC_InitCSIMEstFile(VOS_VOID)
{
    ...
    if(VOS_OK == ulResult) /*该文件的存在不是必须的*/
    {
        ...
        if (VOS_OK != ulResult)
        {
            USIMM_WARNING_LOG("USIMM_UICC_InitCSIMEstFile: Get EF EST from POOL Error");
            return;
        }
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitCSIMEstFile: Read EF EST Error");
    }
...
)
{
    ...
    /*Read EF AD*/
    if (VOS_OK != USIMM_InsertFileToPool(USIMM_CDMA_APP, USIMM_CSIM_EFAD_ID))
    {
        USIMM_WARNING_LOG("USIMM_UICC_InitCsimMFile: USIMM_CSIM_EFAD is Error");
    ...
    /*Save EF CST*/
    if (VOS_OK != USIMM_InsertFileToPool(USIMM_CDMA_APP, USIMM_CSIM_EFCSIMST_ID))
    {
        USIMM_WARNING_LOG("USIMM_UICC_InitCsimMFile: USIMM_CSIM_EFCSIMST is Error");
    ...
    if (VOS_OK != USIMM_InsertFileToPool(USIMM_CDMA_APP, USIMM_CSIM_EFIMSIM_ID))
    {
        USIMM_WARNING_LOG("USIMM_UICC_InitCsimMFile: USIMM_CSIM_EFIMSIM is Error");
    ...
    /*Read UIMID*/
    if (VOS_OK != USIMM_InsertFileToPool(USIMM_CDMA_APP, USIMM_CSIM_EFRUIMID_ID))
    {
        USIMM_WARNING_LOG("USIMM_UICC_InitCsimMFile: USIMM_CSIM_EFIMSIM is Error");
...
)
{
    ...
    for(i = 0;i < ARRAYSIZE(ausCsimInitMFile); i++ )
    {
        ...
        {
            USIMM_WARNING_LOG("USIMM_UICC_InitCsimMFile2: File read failed");
        }
    }
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_UICC_InitCsimEFMecrp: Step is Begin");
    ...
    if (VOS_OK != ulResult)
    {
        USIMM_WARNING_LOG("USIMM_UICC_InitCsimEFMecrp: Update EFMecrp is Error");

        return USIMM_INITSTEPS_REMOVE;
    }

    USIMM_NORMAL_LOG("USIMM_UICC_InitCsimEFMecrp: Step is End");
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_UICC_InitCsimEF3gpd: Step is Begin");
    ...
    if (VOS_OK != ulResult)
    {
        USIMM_WARNING_LOG("USIMM_UICC_InitCsimEF3gpd: Update EF3gpd File is Error");

        return USIMM_INITSTEPS_REMOVE;
    }

    USIMM_NORMAL_LOG("USIMM_UICC_InitCsimEF3gpd: Step is End");
...
{
    USIMM_NORMAL_LOG("USIMM_UICC_InitCsimOPFile: Step is Begin");

    USIMM_NORMAL_LOG("USIMM_UICC_InitCsimOPFile: Step is Over");
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_UICC_InitIsimADF: Select ISIM AID is Error");/*打印错误*/
...
)
{
    ...
    VOS_UINT16                          ausIsimInitMFile[] = {USIMM_ISIM_EFAD_ID,
                                                              ...
                                                              USIMM_ISIM_EFIST_ID};
    VOS_UINT16                          ausIsimFileId[] =    {EFISIMAD,
                                                              EFISIMIMPI,
                                                              EFISIMDOMAIN,
                                                              EFISIMIST};
    VOS_UINT32                          i;
...
)
{
    ...
    if (USIMM_SW_OK == ulCDMAResult)
    {
        ...
        USIMM_NORMAL_LOG("USIMM_ICC_CheckCLStep: Set UIM AID Value");     /*打印*/
    }
    ...
    if (USIMM_SW_OK == ulGsmResult)
    {
        ...
        USIMM_NORMAL_LOG("USIMM_ICC_CheckCLStep: Set SIM AID Value");     /*打印*/
    }
    ...
    {
        USIMM_ERROR_LOG("USIMM_ICC_CheckCLStep: Feature On and 7F25 is Failed");     /*打印错误*/
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_ICC_InitAppOrder(VOS_VOID)
{
    ...
    if (USIMM_TEST_TYPE_GCF_SIM == USIMM_CCB_GetTestCardType())
    {
        if (USIMM_NV_CDMA_APP == USIMM_GetPreferApp())
        {
            ...
            USIMM_WARNING_LOG("USIMM_ICC_InitAppOrder: It is CCF UIM card");     /*打印*/
       }
        else
        {
            ...
            USIMM_WARNING_LOG("USIMM_ICC_InitAppOrder: It is GCF SIM card");     /*打印*/
        }
    ...
    if (VOS_OK == USIMM_ICC_CheckCLStep(&enCardApp))
    {
        ...
        USIMM_WARNING_LOG("USIMM_ICC_InitAppOrder: VIA CL is ON, need reset");     /*打印*/
...
USIMM_COMMINIT_RST_ENUM_UINT32 USIMM_ICC_InitCard(VOS_VOID)
{
    ...
    for (ulStep = 0; ulStep < ARRAYSIZE(g_aICCCommInitProcFuncTbl); ulStep++)
    {
        ...
        {
            USIMM_ERROR_LOG("USIMM_ICC_InitCard: one step return fail");     /*打印*/
            return USIMM_COMM_INIT_FATAL_FAIL;
        }
...
)
{
    ...
    if (0x10 == (USIMM_CCB_GetCurDFInfo(USIMM_GUTL_APP)->ucCharaByte & 0x70)) /*SIM卡根据文件特性字节切换电压*/
    {
        ...
        if (VOS_OK != ulResult)
        {
            USIMM_ERROR_LOG("USIMM_ICC_InitSimADF: Select DFGSM is Failed");
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitSimECC: Step is Begin");

    ulResult = USIMM_InitSimEccFile(ucChannelNo);

    if (VOS_OK == ulResult)
    {
        USIMM_NORMAL_LOG("USIMM_ICC_InitSimECC: Step is OK");

        return USIMM_INITSTEPS_SUCCESS;
    }
    else
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitSimECC: Step is Fail");
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitSST: Step is End");
...
)
{
    ...
    if(VOS_OK != ulResult)
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitTerminalProfile: Send Command Error");
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitTerminalProfile: Step is End");
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitSimFBDN: Select EFIMSI Error");
    ...
    if (VOS_OK != ulResult)/*判断结果和文件状态*/
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitSimFBDN: Select EFLOCI Error");
...
)
{
    ...
    VOS_UINT16                          ausSimRealFile[] = {EFIMSI, EFAD};
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitSimMFile: Step is End");
...
)
{
    ...
    for(i = 0;i < ARRAYSIZE(ausSimInitMFile); i++ )
    {
        if(VOS_OK != USIMM_InsertFileToPool(USIMM_GUTL_APP, ausSimInitMFile[i]))
        {
            USIMM_WARNING_LOG("USIMM_ICC_InitSimMFile2:Read Mandatory File Failed");
        }
    }
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitSimFinish: Step is End");
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitSimOPFile: Step is End");
...
)
{
    ...
    if (VOS_OK != ulResult)
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitUimADF: Select UIM Card DFCDMA is Failed");     /*打印错误*/
    ...
    if (0x10 == (USIMM_CCB_GetCurDFInfo(USIMM_CDMA_APP)->ucCharaByte & 0x70)) /*SIM卡根据文件特性字节切换电压*/
    {
        ...
        if (USIMM_SCI_NONEED_CHANGEVCC == lVoltageSwitchRst)
        {
            USIMM_NORMAL_LOG("USIMM_ICC_InitUimADF: No need change VCC, step is OK");
        ...
        if (VOS_OK != ulResult)
        {
            USIMM_ERROR_LOG("USIMM_ICC_InitUimADF: Select DF CDMA is Failed");
...
)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_ICC_InitUimRuimId: Read EFRUIMID error");
    }

    USIMM_NORMAL_LOG("USIMM_ICC_InitUimRuimId: Step is End");
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitCST: Step is End");
...
)
{
    ...
    USIMM_NORMAL_LOG("USIMM_ICC_InitUimFdnBdn: Step is End");
...
VOS_UINT32 USIMM_ICC_InitUimFdnStatus(VOS_VOID)
{
    ...
    if (VOS_OK != ulResult)/*判断结果和文件状态*/
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitUimFdnStatus: Select EF_CUIM_IMSIM Error");
    ...
    if (VOS_OK != ulResult)/*判断结果和文件状态*/
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitUimFdnStatus: Select EF_CUIM_IMSIT Error");
...
)
{
    ...
    if (PS_USIM_SERVICE_NOT_AVAILIABLE == USIMM_IsServiceAvailable(UIM_SVR_FDN))
    {
        *pulFdnStatus = USIMM_FDNSTATUS_OFF;
        ...
        USIMM_WARNING_LOG("USIMM_ICC_FdnCapabilityRequest: FDN SVR OFF");
    ...
    if (PS_USIM_SERVICE_NOT_AVAILIABLE == USIMM_IsServiceAvailable(UIM_SVR_ADN))
    {
        *pulFdnStatus = USIMM_FDNSTATUS_ON;
        ...
        USIMM_WARNING_LOG("USIMM_ICC_FdnCapabilityRequest:ADN SVR OFF, FDN is ON");
    ...
    if (VOS_OK != ulResult)
    {
        *pulFdnStatus = USIMM_FDNSTATUS_ON;
        ...
        USIMM_WARNING_LOG("USIMM_ICC_FdnCapabilityRequest: Select ADN fail, FDN is ON");
    }
    else
    {
        /* ADN文件无效,FDN激活 */
        if (USIMM_EFSTATUS_DEACTIVE == USIMM_CCB_GetCurEFInfo(USIMM_CDMA_APP)->enFileStatus)
        {
            *pulFdnStatus = USIMM_FDNSTATUS_ON;
            ...
            USIMM_WARNING_LOG("USIMM_ICC_FdnCapabilityRequest: ADN is deactive, FND is ON");
        }
        /* ADN文件有效,FDN未激活 */
        else
        {
            *pulFdnStatus = USIMM_FDNSTATUS_OFF;
            ...
            USIMM_NORMAL_LOG("USIMM_ICC_FdnCapabilityRequest: ADN is active, FND is OFF");
        }
    }
...
)
{
    ...
    if (NV_OK != NV_Read(en_NV_Item_Usim_Support_Feature_Config, &stUsimmFeatureCfg, sizeof(USIMM_FEATURE_CFG_STRU)))
    {
        USIMM_ERROR_LOG("USIMM_ICC_InitStoreEsnMeid: NV_Read en_NV_Item_Usim_Support_Feature_Config Failed");
    ...
    if (PS_USIM_SERVICE_AVAILIABLE == ulSvcStatus)
    {
        ...
        {
            USIMM_ERROR_LOG("USIMM_ICC_InitStoreEsnMeid: USIMM_SendStoreESNMEIDApdu Failed");
        }
    }
