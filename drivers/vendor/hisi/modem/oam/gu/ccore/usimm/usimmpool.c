    ...
    USIMM_CARDAPP_ENUM_UINT32           enAppType)
{
    ...
    if(VOS_NULL == pstPoolGlobal->ucPoolFileCount)  /*当前内容为空*/
    {
        ...
        {
            USIMM_WARNING_LOG("USIMM_PoolFindFile: Pool is empty");
     ...
     && (0                              != usEFileId))
    {
        ...
        {
            USIMM_WARNING_LOG("USIMM_PoolFindFile: App status is wrong");
    ...
    USIMM_NORMAL_LOG("USIMM_PoolFindFile: Could not find file");
...
)
{
    ...
    if((USIMM_POOL_NOINTIAL == pstPoolGlobal->enPoolStatus)
     ...
     ||(VOS_NULL            == pstRecord->usEFId))   /*状态检查*/
    {
        USIMM_ERROR_LOG("USIMM_PoolInsertOneFile: Pool is full or status is wrong");/*打印错误*/
    ...
    {
        USIMM_ERROR_LOG("USIMM_PoolInsertOneFile: Could not Found empty record");/*打印错误*/
...
VOS_UINT32 USIMM_UsimVoltageSwitch(VOS_UINT8 ucCharaByte, VOS_UINT8 *pucVoltageMismatchFlag)
{
    ...
    if (USIMM_VOLTAGE_3V == (ucCharaByte & USIMM_VOLTAGE_3V))
    {
        *pucVoltageMismatchFlag = VOS_TRUE;
        ...
        {
            USIMM_ERROR_LOG("USIMM_UsimVoltageSwitch:USIMM_DLResetCard Failed.");
        ...
        {
            USIMM_NORMAL_LOG("USIMM_UsimVoltageSwitch: No need change Vcc.");
            return VOS_OK;
        }
    ...
    VOS_UINT8                           ucChannelID)
{
    ...
    {
        USIMM_WARNING_LOG("USIMM_AttUpdataSupportTable: Select 6FD2 Error");
    ...
    {
        USIMM_WARNING_LOG("USIMM_AttUpdataSupportTable: Update 6FD2 Fail");
    }
...
VOS_UINT32 USIMM_InitUsimEccFile(VOS_VOID)
{
    ...
    if(VOS_OK != ulResult)/*判断结果*/
    {
        ...
        USIMM_ERROR_LOG("USIMM_InitUsimEccFile:Select ECC file fail");
    ...
    if(USIMM_EFSTRUCTURE_FIXED != pstCurEFInfo->enFileType)
    {
        ...
        USIMM_ERROR_LOG("USIMM_InitUsimEccFile:ECC filetype error");
    ...
    if(USIMM_SW_OK != ulResult)/*判断结果*/
    {
        ...
        USIMM_ERROR_LOG("USIMM_InitUsimEccFile:Read ECC error");
    ...
    VOS_UINT8                           ucChannelID)
{
    ...
    if (VOS_NULL_PTR == pstCurEFInfo)
    {
        USIMM_ERROR_LOG("USIMM_InitSimEccFile:USIMM_CCB_GetCurEFInfo error");
    ...
    if(USIMM_EFSTRUCTURE_TRANSPARENT != pstCurEFInfo->enFileType)
    {
        ...
        USIMM_ERROR_LOG("USIMM_InitSimEccFile:ECC Filetype error");
    ...
    if(USIMM_SW_OK != ulResult)/*判断结果*/
    {
        ...
        USIMM_ERROR_LOG("USIMM_InitSimEccFile:Read ECC error");
...
)
{
    ...
    {
        USIMM_ERROR_LOG("USIMM_SelectEFByID: The Input App Error");
    ...
    USIMM_CURFILEINFO_ST               *pstCurFileInfo)
{
    ...
    {
       USIMM_WARNING_LOG("USIMM_SelectFileByRelativePath: Cur file path is NULL.");
       return USIMM_SW_ERR;
    }
...
VOS_UINT32 USIMM_RefreshICCFile(USIMM_STKREFRESH_REQ_STRU       *pstMsg)
{
    ...
    if (USIMM_CARDAPP_BUTT == enAppType)
    {
        ...
        USIMM_WARNING_LOG("USIMM_RefreshICCFile: Main App error return Error");
    ...
    if (VOS_ERR == USIMM_GetAppInitList(enAppType, &stRefreshCtrl.pfList, &stRefreshCtrl.ucInitListNum))
    {
        ...
        USIMM_WARNING_LOG("USIMM_RefreshICCFile: USIMM_GetAppInitList return Error");
...
VOS_UINT32 USIMM_RefreshUICCFile(USIMM_STKREFRESH_REQ_STRU      *pstMsg)
{
    ...
    if (USIMM_CARDAPP_BUTT == enAppType)
    {
        ...
        USIMM_WARNING_LOG("USIMM_RefreshUICCFile: Refresh enAppType Error");
