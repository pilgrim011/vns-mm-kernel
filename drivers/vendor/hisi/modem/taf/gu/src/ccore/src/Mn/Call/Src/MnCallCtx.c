...
/*****************************************************************************
 函 数 名  : TAF_CALL_SetCcwaiMode
 功能描述  : 设置CCWAI的mode
 输入参数  : TAF_CALL_CCWAI_MODE_ENUM_UINT8      enCcwaiMode
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : TAF_CALL_GetCcwaiMode
 功能描述  : 获取CCWAI的mode
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : TAF_CALL_CCWAI_MODE_ENUM_UINT8      enCcwaiMode
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : TAF_CALL_GetCallRedialForDiscSupportFlg
 功能描述  : 获取是否支持基于disconnect原因值的呼叫重建功能标识
 输入参数  : 无
 输出参数  : 无
 返 回 值  : VOS_TRUE  - 支持基于disconnect原因值的呼叫重建功能
                        VOS_FALSE - 不支持基于disconnect原因值的呼叫重建功能
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : TAF_CALL_SetDiscCause
 功能描述  : 设置网络disconnect挂断原因值
 输入参数  : enDiscCause -- disconnect原因值
...
/*****************************************************************************
 函 数 名  : TAF_CALL_GetDiscCause
 功能描述  : 获取网络disconnect挂断原因值
