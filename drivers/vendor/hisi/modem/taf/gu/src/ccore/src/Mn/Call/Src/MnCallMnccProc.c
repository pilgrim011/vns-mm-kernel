...
)
{
    ...
    /*添加根据disconnect原因值重试的话，收到Proceding时不需要停止重试*/
    /*不影响eCall和其他Call原有重试流程*/
...
/*****************************************************************************
 函 数 名  : TAF_CALL_StopVoiceCallRedialForDisc
 功能描述  : 终止语音呼叫重拨
 输入参数  : ucCallId         － 呼叫标识
