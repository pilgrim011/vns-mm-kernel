...
/*****************************************************************************
 函 数 名  : TAF_MMA_CompareSTKRefreshWithPhoneMode
 功能描述  : 将MMA收到的STK Refresh消息与phone mode状态机的优先级进行比较
 输入参数  : ulEventType:消息类型
             pstMsg     :消息内容
 输出参数  : penAbortType:打断类型
 返 回 值  : 比较结果
...
/*****************************************************************************
 函 数 名  : TAF_MMA_CompareSTKRefreshWithSysCfg
 功能描述  : 将MMA收到STK Refresh消息与SYS CFG状态机的优先级进行比较
 输入参数  : ulEventType : 消息类型
             pstMsg      : 消息内容
 输出参数  : penAbortType: 打断类型
 返 回 值  : 比较结果
