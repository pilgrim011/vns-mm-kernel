...
VOS_VOID  MN_CALL_ReadCallRedialCfgNvim( VOS_VOID )
{
    ...
    /* 如果NV读取失败，则设置为不激活 */
    /*如果总的重拨开关打开了，那么读取disconnect重试配置的NV*/
...
/*****************************************************************************
 函 数 名  : MN_CALL_ReadCallRedialDiscCauseCfgNvim
 功能描述  : 获取NVIM中的MN_CALL_ReadCallRedialDiscCauseCfgNvim的内容
 输入参数  : 无
 输出参数  : 无
 返 回 值  :
 调用函数  :
