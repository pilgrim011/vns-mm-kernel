...
/*****************************************************************************
 函 数 名  : TAF_SDC_GetErrLogImsCallFailFlag
 功能描述  : 获取ims call fail flag
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_UINT8
 调用函数  :
...
/*****************************************************************************
 函 数 名  : TAF_SDC_SetErrLogImsCallFailFlag
 功能描述  : 设置ims call fail flag
 输入参数  : VOS_UINT8 ucImsCallFailFlag
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : TAF_SDC_GetErrLogImsCallFailCause
 功能描述  : 获取ims call fail cause
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_UINT32
 调用函数  :
...
/*****************************************************************************
 函 数 名  : TAF_SDC_SetErrLogImsCallFailCause
 功能描述  : 设置ims call fail cause
 输入参数  : VOS_UINT32 ulImsCallFailCause
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
 被调函数  :
...
/*****************************************************************************
 函 数 名  : TAF_SDC_InitErrLogImsCallFailInfo
 功能描述  : 初始化IMS CALL FAIL INFO
 输入参数  : VOS_VOID
 输出参数  : 无
 返 回 值  : VOS_VOID
 调用函数  :
