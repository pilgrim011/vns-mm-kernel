...
/* HS: Pruned as balong suports only manual ipsec */
    ...
    METHOD_(ULONG, pfIPSEC_ActivateModPolicy)(IPSEC_POLICY_NAME_SEQ_S *pstPolicyNameAndSeq);  /*173*/

    METHOD_(ULONG, pfIPSEC_DelSABySPI)(ULONG ulInboundSpi, ULONG ulOutboundSPI, 
                                                ULONG ulDestAddr, UCHAR ucProto);            /*174*/
