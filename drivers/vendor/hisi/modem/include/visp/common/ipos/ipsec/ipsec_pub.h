...
typedef struct tagIPsecIPSecSAContent
{
    ...
    UCHAR ucIsProfile;
    UCHAR ucEasyVpnMode;
    UCHAR ucOldSAPolicyMod; /*For smooth switchover to dispplay old sa */
} IPSEC_SA_CONTENT_S;
...
#define tdb_ivq IV.Ivq
    ...
    UCHAR  ucOldSAPolicyMod;        /* Set when tdb is Old SA because of policy modification */
...
/* PPI Callback API for IPv4 */
typedef struct tagIPSEC_GET_IPPKT_CALLBACK_S
{
    ULONG (* pfGetSendIPPktBeforeEncryption) (MBUF_S *pstMBuf);
    ULONG (* pfGetSendIPPktAfterEncryption) (MBUF_S *pstMBuf);
    ULONG (* pfGetRecvIPPktBeforeDecryption) (MBUF_S *pstMBuf);
    ULONG (* pfGetRecvIPPktAfterDecryption) (MBUF_S *pstMBuf);
}IPSEC_GET_IPPKT_CALLBACK_S;

/* PPI Callback API for IPv6 */
typedef struct tagIPSEC6_GET_IPPKT_CALLBACK_S
{
    ULONG (* pfGetSendIPPktBeforeEncryption) (MBUF_S *pstMBuf);
    ULONG (* pfGetSendIPPktAfterEncryption) (MBUF_S *pstMBuf);
    ULONG (* pfGetRecvIPPktBeforeDecryption) (MBUF_S *pstMBuf);
    ULONG (* pfGetRecvIPPktAfterDecryption) (MBUF_S *pstMBuf);
}IPSEC6_GET_IPPKT_CALLBACK_S;

extern IPSEC_GET_IPPKT_CALLBACK_S g_stIPSEC_PPICallbackAPI_head;
extern IPSEC6_GET_IPPKT_CALLBACK_S g_stIPSEC6_PPICallbackAPI_head;
