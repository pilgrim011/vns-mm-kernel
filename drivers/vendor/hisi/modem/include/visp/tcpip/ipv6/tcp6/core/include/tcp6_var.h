...
/*Modified by y00216869 for DTS2016080205624 :同步c70需求（来自balong产品），支持2msl可配置 , 2016/8/03 */
/*此处修改是为了与tcp4保持一致，balong分支经王永哲确认ims目前没有设置过下面的选项*/
#define TCP6_KEEPALIVE_IDLE  3       /* set/get TCP Keepalive timer value */
#define TCP6_KEEPALIVE_CNT   4       /* set/get TCP Keepalive probe count */
#define TCP6_KEEPALIVE_INTVL 5       /* set/get TCP Keepalive probing interval*/
#define TCP6_MSL             6       /* set/get TCP Maximum Segment Lifetime */
#define TCP6_STDURG          7
 /*Modified by y00216869 for DTS2016080205624 :同步c70需求（来自balong产品），支持2msl可配置 , 2016/8/03 */
...
/*Added by y00216869 for DTS2016080205624 :同步c70需求（来自balong产品），支持2msl可配置 , 2016/8/03 */
#define    TCP6_MIN_MSL  1    /* 支持msl可配置的最小值 */
#define    TCP6_MAX_MSL  120 /* 支持msl可配置的最大值*/
/*End added by y00216869 for DTS2016080205624 :同步c70需求（来自balong产品），支持2msl可配置 , 2016/8/03 */
...
extern ULONG            g_ulTCP6MSLDefault;
