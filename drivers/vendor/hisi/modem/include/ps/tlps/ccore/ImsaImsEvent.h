...
enum IMSA_IMS_INT_ERROR_CODE_ENUM
{
    ...
    IMSA_IMS_INT_ERROR_CODE_CALL_IMSA_ERR = 111,
    IMSA_IMS_INT_ERROR_CODE_CALL_NETWORK_ERR = 112,
...
typedef struct {
    ...
    VOS_UINT8                               aucRsv[3];
    VOS_UINT32                              ulDlgId;  /* Added for forking, indicates the dialog id  取值范围: UINT16 < ulDlgId < UINT32 */
...
typedef struct {
    ...
    VOS_CHAR                               acAlpha[IMSA_IMS_ALPHA_STRING_SZ + 1];
    VOS_UINT8                              aucRsv2[3];
    VOS_UINT32                             ulDlgId; /* Indicates the dialog id, 取值范围: UINT16 < ulDlgId < UINT32*/
